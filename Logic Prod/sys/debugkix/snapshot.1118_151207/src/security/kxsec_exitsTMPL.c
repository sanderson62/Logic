...
/* $Date:   19 Oct 2011 10:37:38  $ */
/* $Modtime:   19 Oct 2011 10:34:40  $ */

#ifndef	lint
#ifdef __STDC__
const
#endif
static char sccsid[] = "@(#) $Workfile:   kxsec_exits.c  $ $Revision:   1.3  $";
#endif

/*
 * $Log:   /ENG/ss134151/unikixversions/TPE11.3.2-SOL/unikixsrc/user/security/PVCS/kxsec_exits.c_v  $
 * 

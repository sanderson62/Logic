...
/* $Date:   13 Jan 2009 15:25:58  $ */
/* $Modtime:   13 Jan 2009 15:25:58  $ */

#ifndef	lint
#ifdef __STDC__
const
#endif
static char sccsid[] = "@(#) $Workfile:   kixmakecnv.c  $ $Revision:   1.1  $";
#endif

/*
 * $Log:   /builds/dd134127/source/TPE11.2.0a/unikixsrc/user/convert/PVCS/kixmakecnv.c_v  $
 * 

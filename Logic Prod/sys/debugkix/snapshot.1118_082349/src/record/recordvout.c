...
const
#endif
static char sccsid[] = "@(#) $Workfile:   recordvout.c  $ $Revision:   1.4  $";
#endif

/*
 * $Log:   /builds/source/TPE12.1a.PVCS/unikixsrc/user/record/PVCS/recordvout.c_v  $
 *
 *    Rev 1.4   23 Apr 2013 13:24:46   unikix
 * Update Dell copyright
 *
 *    Rev 1.3   18 Jan 2013 08:56:40   unikix
 * Dell rebranding
 *

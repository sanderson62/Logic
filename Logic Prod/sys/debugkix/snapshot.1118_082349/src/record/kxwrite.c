...
const
#endif
static char sccsid[] = "@(#) $Workfile:   kxwrite.c  $ $Revision:   1.3  $";
#endif

/*
 * $Log:   /builds/source/TPE12.1a.PVCS/unikixsrc/user/record/PVCS/kxwrite.c_v  $
 *
 *    Rev 1.3   23 Apr 2013 13:24:44   unikix

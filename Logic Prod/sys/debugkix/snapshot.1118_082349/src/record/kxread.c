...
const
#endif
static char sccsid[] = "@(#) $Workfile:   kxread.c  $ $Revision:   1.3  $";
#endif

/*
 * $Log:   /builds/source/TPE12.1a.PVCS/unikixsrc/user/record/PVCS/kxread.c_v  $
 *
 *    Rev 1.3   23 Apr 2013 13:24:42   unikix
 * Update Dell copyright
 *
 *    Rev 1.2   18 Jan 2013 08:56:36   unikix
 * Dell rebranding
 *

...
/************************************************************************/
/*  Define user functions prototypes ORACLE, DBTWO, SYBASE, ESQL,       */
/*  MSSQL, and MQSERIES                                                 */
...
/* Case # 2388 */
#define MAX_AM ORACLE_AM + SYBASE_AM + MSSQL_AM + DBTWO_AM + ESQL_AM + MQSERIES_AM
...
/*  the prototype ORACLE, SYBASE, DBTWO, etc. function addresses.       */
...
static int rcode;
static int errind;
int kxusrexit_batch_mode = 0; /* will be set to 1 by runner.c */
/* Case 2388 */
#if defined ORACLE || defined SYBASE || defined MSSQL \

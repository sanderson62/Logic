...
chomp($mdate);
print("$mdate\n");
system "ftp -n ntcso1 < $JCLLIB/ftp-get-mtp";
...
if ($infilesz != $otfilesz) {
   ...
   system "ftp -n ntcso1 < $JCLLIB/ftp-put-mtp";
   "cat $PROJECT_ROOT/emails/move_to_prod.txt; | mutt -s .'$movedfiles'.  MovetoPROD@cso.com"

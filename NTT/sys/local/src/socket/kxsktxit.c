...
#include <sys/types.h>
#ifdef WIN_NATIVE
#include <winsock2.h>		/* use native Windows socket library */
#define in_port_t int		/* like WinSock2.h seems to use */
#define in_addr_t int		/* like WinSock2.h seems to use */
#else

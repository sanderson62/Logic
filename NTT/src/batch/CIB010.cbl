...
101708* 101708    2008050500001  AJRA  ADD DCC4
011110* 011110    2007101100001  AJRA  REMOVE PERIOD FROM LETTER MEMBER NAME
...
NTTDel*    05  AGEB16-BC-LEN       SHORT.
NTTIns     05  AGEB16-BC-LEN       PIC S9(4) COMP.
...
101708               OR (M420C-FORM = 'DCC4' AND DTE-CLIENT = 'DCC')
091808               OR (M420C-FORM = 'AKCK' AND DTE-CLIENT = 'CID')
030612               OR (M420C-FORM = '420A' AND DTE-CLIENT = 'AHL') 
030612               OR (M420C-FORM = 'AKAH' AND DTE-CLIENT = 'AHL')
...
011110*    PERFORM 810-SET-PERIOD THRU 810-EXIT                         02120001
           ...
           MOVE M420C-CLAIM-NO  TO LR-CLAIM-NO                          02190005
                                                                        02211406
052614     IF M420C-PLAN-CODE = 'A&H ' OR 'IU  ' OR 'GAP ' OR 'FAM '
022122        or 'HOS ' or 'BRV '

...
00002                                                                   
NTTDel*PROGRAM-ID.                ECS082.                               
NTTIns PROGRAM-ID. ECS082SP.
...
PEMTST*            7 - OVERALL TOTALS GROSS ONLY
00049  EJECT                                                            
00050 *       --- ECS082 ---                                            
...
030404* 030404                   SMVA  STOP PROCESSING IF GAAP FILE EMPTY 
042904* 042904                   PEMA  ADD PGM OPT 7 FOR CORP FIN
061008* 061008    2008052100004  AJRA  CREATE EXTRACT FILE OF ACCOUNT TOTALS
100208* 100208    2008073000002  AJRA  CREATE ANOTHER EXTRACT FILE FOR RETRO
120610* 120610    2010112200002  AJRA  ADD REIN GROUP A TO EXTRACT KEY
...
100208     SELECT DATA-OUT2 ASSIGN TO SYS024-UT-2400-S-SYS024
100208                      ORGANIZATION IS LINE SEQUENTIAL. 
00096                                                                   
00097  EJECT                                                            
00098  DATA DIVISION.                                                   
00099  FILE SECTION.                                                    
...
00102                                    .                              
00103  01  SRT-REC.                                                     
120610*00104      12  S-PARM                  PIC X(46).                       
061008*00105      12  FILLER                  PIC X(158).
120610     12  S-PARM                  PIC X(52).
061008     12  FILLER                  PIC X(188).                      
00106                                                                   
00107  FD  PRNTR                                                        
00108                              COPY ELCPRTFD.                       
00109  EJECT                                                            
...
061008                             
061008 01  DATA-OUT-REC               PIC X(250).
061008
100208 FD  DATA-OUT2
100208     RECORDING MODE F 
100208     BLOCK CONTAINS 0 RECORDS.
100208                             
100208 01  DATA-OUT-REC2              PIC X(519).
100208
00128  EJECT                                                            
...
061008 77  WS-PRT-DATA-FILE            PIC X(1)   VALUE 'N'.
100208 77  WS-PRT-DATA-FILE2           PIC X(1)   VALUE 'N'.
00167                                                                   
00168  EJECT                                                            
00169  01  WS.                                                          
...
061008     12  WS-SAVE-RCOSUB      PIC X(03)   VALUE SPACES.            
120610     12  WS-SAVE-REIN-GROUPA PIC X(06)   VALUE SPACES.
...
120610     12  HDF-REIN-GRPA-HEAD  PIC X(13)           VALUE SPACES.
120610     12  HDF-REIN-GROUPA     PIC X(6)            VALUE SPACES.
00280                                                                   
00281  01  HDG.                                                         
...
120610             20  W-REIN-GROUPA   PIC X(6).
...
061008         16  W-ACCT-NAME         PIC X(30).         
00437      12  ACCT-SEQ.                                                
...
120610         16  CUR-REIN-GROUPA PIC X(6).
...
120610         16  WX-REIN-GROUPA  PIC X(6).
...
00497  01  X-M-TOTALS.                                                  
111203     12  XM-TAB                  OCCURS 80 TIMES.                 
...
111203     12  REIN-SUB-M-TOTS             OCCURS 80 TIMES.             
...
061008     05  DO-REIN-BY-NUM.
061008         10  DO-REIN-BY-PRIME PIC X(3).
061008         10  DO-REIN-BY-SUB   PIC X(3).
...
061008     05  DO-ACCUMULATORS.
061008         10  DO-LF78          PIC -(11).99.
061008         10  DO-LFPR          PIC -(11).99.
061008         10  DO-LFMORT        PIC -(11).99.
061008         10  DO-AH78          PIC -(11).99.
061008         10  DO-AHPR          PIC -(11).99.
061008         10  DO-AHMEAN        PIC -(11).99.
061008     05  DO-TOTAL-TYPE        PIC X(1).
061008     05  FILLER               PIC X(41).
061008                                                                   
100208 01  RUN-DT                  PIC 9(11).                           
100208 01  RUN-DT-R REDEFINES RUN-DT.                                   
100208     12  FILLER              PIC 999.                             
100208     12  RD-CCYY             PIC 9(04).                           
100208     12  RD-CCYR REDEFINES RD-CCYY.                               
100208         16  RD-CC           PIC 99.                              
100208         16  RD-YR           PIC 99.                              
100208     12  RD-MO               PIC 99.                              
100208     12  RD-DA               PIC 99.                              
100208
100208 01  DATA-OUT-RECORD2.
100208     05  DO2-ME-DATE.
100208         10  DO2-ME-MO        PIC 9(2).
100208         10  FILLER           PIC X(1)    VALUE '/'.
100208         10  DO2-ME-DD        PIC 9(2).
100208         10  FILLER           PIC X(1)    VALUE '/'.
100208         10  DO2-ME-YR        PIC 9(4).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-CARRIER          PIC X(1).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-CERT-GROUP       PIC X(6).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-STATE            PIC X(2).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-ACCOUNT-NUM      PIC X(10).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-ACCOUNT-NAME     PIC X(30).
100208     05  FILLER               PIC X(1)    VALUE ';'.
100208     05  DO2-ACCUMULATORS.
100208         10  DO2-LFINF        PIC -(8)9.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFWRIT       PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LF78         PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFPR         PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFDOMSTAT    PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFSTSTAT     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFMORT       PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFREMAIN     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHINF        PIC -(8)9.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHWRIT       PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AH78         PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHPR         PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHDOMSTAT    PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHSTSTAT     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHREMAIN     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFCOMM       PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFCOMM78     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFCOMMPR     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFCOMMDOM    PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFTAX        PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFTAX78      PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFTAXPR      PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-LFTAXDOM     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHCOMM       PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHCOMM78     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHCOMMPR     PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHCOMMDOM    PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHTAX        PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHTAX78      PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHTAXPR      PIC -(11).99.
100208         10  FILLER           PIC X(1)    VALUE ';'.
100208         10  DO2-AHTAXDOM     PIC -(11).99.
100208                                                                   
00828                              COPY ELCDTECX.                       
00829                                                                   
00830                              COPY ELCDTEVR.                       
...
100208     MOVE RUN-DATE        TO  RUN-DT.                         
100208     MOVE RD-MO           TO  DO2-ME-MO.
100208     MOVE RD-DA           TO  DO2-ME-DD.
100208     MOVE RD-CCYY         TO  DO2-ME-YR.
00842                                                                   
...
030404        AND W-TOTAL-RECORDS-READ NOT = +0
...
00870                  GAAP-EXTR                                        
00871           OUTPUT PRNTR.   
100208     OPEN OUTPUT DATA-OUT DATA-OUT2.   
00872                                                                   
...
00915                                                                   
120610*00916      IF GR-LFSRV NOT NUMERIC                                      
120610*00917          MOVE ZEROS       TO GR-LFSRV.                            
120610*00918      IF GR-AHSRV NOT NUMERIC                                      
120610*00919          MOVE ZEROS       TO GR-AHSRV.                            
00920                                                                   
...
120610     MOVE AM-REI-GROUP-A TO WS-SAVE-REIN-GROUPA.
00969                                                                   
...
040114        MOVE GRD-LFPRM    TO  X-DOMICILE
040114     ELSE
040114        MOVE GRS-LFPRM    TO  X-DOMICILE
040114     END-IF.
...
040114     IF DTE-CLIENT = 'DCC'
040114        MOVE GRD-LFCOM    TO  X-CDOMI
040114     ELSE
040114        MOVE GRS-LFCOM    TO  X-CDOMI
040114     END-IF
052303     IF DTE-CLIENT NOT = 'DCC'
040114         COMPUTE X-TDOMI ROUNDED = 
...
01032 ****** FIELDS.                                                    
01033                                                                   
120610*01034      MOVE GR-LFSRV     TO X-SFPAID.                               
120610*01035      IF GR-LFPRM EQUAL ZEROS                                      
01036          MOVE ZEROS    TO X-SF78                                  
01037                           X-SFRATA                                
01038                           X-SFDOMI                                
120610*01039      ELSE                                                         
120610*01040          COMPUTE X-SF78 ROUNDED =                                 
120610*01041                             (GRR-LFPRM / GR-LFPRM) * GR-LFSRV     
120610*01042          COMPUTE X-SFRATA ROUNDED =                               
120610*01043                             (GRP-LFPRM / GR-LFPRM) * GR-LFSRV     
120610*01044          COMPUTE X-SFDOMI ROUNDED =                               
120610*01045                             (GRD-LFPRM / GR-LFPRM) * GR-LFSRV.    
01046                                                                   
...
061008     MOVE WS-SAVE-ACCT-NAME   TO W-ACCT-NAME.
120610     MOVE WS-SAVE-REIN-GROUPA TO W-REIN-GROUPA.
...
040114     IF DTE-CLIENT = 'DCC'
040114        MOVE GRD-AHPRM     TO  X-DOMICILE
040114     ELSE
040114        COMPUTE X-DOMICILE ROUNDED = (GRR-AHPRM + GRP-AHPRM) / 2
040114     END-IF
...
040114     IF DTE-CLIENT = 'DCC'
040114        MOVE GRD-AHCOM     TO  X-CDOMI
040114     ELSE
040114        COMPUTE X-CDOMI ROUNDED = (GRR-AHCOM + GRP-AHCOM) / 2
040114     END-IF
052303     IF DTE-CLIENT NOT = 'DCC' 
040114         COMPUTE X-TDOMI ROUNDED =
040114           (GRR-AHTAX + GRP-AHTAX) / 2
...
01291 ****** FIELDS.                                                    
01292                                                                   
120610*01293      MOVE GR-AHSRV     TO X-SFPAID.                               
120610*01294      IF GR-AHPRM EQUAL ZEROS                                      
01295          MOVE ZEROS    TO X-SF78                                  
01296                           X-SFRATA                                
01297                           X-SFDOMI                                
120610*01298      ELSE                                                         
120610*01299          COMPUTE X-SF78 ROUNDED =                                 
120610*01300                             (GRR-AHPRM / GR-AHPRM) * GR-AHSRV     
120610*01301          COMPUTE X-SFRATA ROUNDED =                               
120610*01302                             (GRP-AHPRM / GR-AHPRM) * GR-AHSRV     
120610*01303          COMPUTE X-SFDOMI ROUNDED =                               
120610*01304                             (GRD-AHPRM / GR-AHPRM) * GR-AHSRV.    
01305                                                                   
...
030404     IF W-TOTAL-RECORDS-READ > +0
030404         CONTINUE
030404     ELSE
030404         GO TO 1099-EXIT
030404     END-IF.
01499                                                                   
...
061008         MOVE W-ACCT-NAME TO WS-SAVE-ACCT-NAME                                    
120610         MOVE W-REIN-GROUPA TO WS-SAVE-REIN-GROUPA
...
061008     MOVE CUR-RCOSUB       TO WS-SAVE-RCOSUB.                        
01538                                                                   
...
120610
120610     IF CUR-REIN-GROUPA GREATER THAN SPACES
120610         MOVE 'REIN GROUPA'  TO  HDF-REIN-GRPA-HEAD
120610         MOVE CUR-REIN-GROUPA TO HDF-REIN-GROUPA
120610     END-IF.
01789                                                                   
...
01847                                                                   
061008     IF CUR-REC-TYPE = '4'
061008        MOVE CUR-RCO           TO DO-REIN-BY-PRIME
061008        MOVE WS-SAVE-RCOSUB    TO DO-REIN-BY-SUB
061008        MOVE WS-SAVE-REIN-BY   TO DO-REIN-BY-NAME
061008        MOVE WS-SAVE-CEDE-FROM TO DO-CEDED-FROM-NAME
061008        MOVE CUR-RCO           TO DO-REIN-PRIME
120610        MOVE CUR-REIN-GROUPA   TO DO-REIN-GROUP
061008        MOVE CUR-CARR          TO DO-CARRIER
061008        MOVE CUR-CO            TO DO-CERT-GROUP
061008        MOVE CUR-ST            TO DO-STATE
061008        MOVE CUR-ACCT          TO DO-ACCOUNT-NUM
061008        MOVE WS-SAVE-ACCT-NAME TO DO-ACCOUNT-NAME
061008        MOVE '1'               TO DO-TOTAL-TYPE
061008        MOVE 'Y' TO WS-PRT-DATA-FILE
061008     END-IF.
061008
100208     IF CUR-REC-TYPE = LOW-VALUES
100208        MOVE CUR-CARR          TO DO2-CARRIER
100208        MOVE CUR-CO            TO DO2-CERT-GROUP
100208        MOVE CUR-ST            TO DO2-STATE
100208        MOVE CUR-ACCT          TO DO2-ACCOUNT-NUM
100208        MOVE WS-SAVE-ACCT-NAME TO DO2-ACCOUNT-NAME
100208        MOVE 'Y' TO WS-PRT-DATA-FILE2
100208     END-IF.
100208
...
120610     MOVE WX-REIN-GROUPA TO CUR-REIN-GROUPA.
01853                                                                   
...
01869                                  HDD.                             
120610     MOVE SPACES             TO  HDF-REIN-GRPA-HEAD
120610                                 HDF-REIN-GROUPA.
01870                                                                   
...
02138                                                                   
042904     IF (DTE-PGM-OPT  = 7)
042904        AND (CUR-REC-TYPE NOT = '4' AND '5')
042904        PERFORM 2000-BLD-RTN  THRU  2099-EXIT
042904     END-IF
02138                                                                   
...
061008
061008     IF CUR-REC-TYPE = '4' AND 
061008       WS-PRT-DATA-FILE = 'Y'
061008         MOVE X-P78      TO  DO-LF78
061008         MOVE X-PRATA    TO  DO-LFPR
061008         MOVE X-RESERV   TO  DO-LFMORT
061008     END-IF.                  
100208
100208     IF (CUR-REC-TYPE = LOW-VALUES) AND 
100208       WS-PRT-DATA-FILE2 = 'Y'
100208         MOVE X-COUNT    TO  DO2-LFINF
100208         MOVE X-WRITTEN  TO  DO2-LFWRIT
100208         MOVE X-P78      TO  DO2-LF78
100208         MOVE X-PRATA    TO  DO2-LFPR
100208         MOVE X-DOMICILE TO  DO2-LFDOMSTAT
100208         MOVE X-STATE    TO  DO2-LFSTSTAT
100208         MOVE X-RESERV   TO  DO2-LFMORT
100208         MOVE X-REMAIN   TO  DO2-LFREMAIN
100208     END-IF.                  
02439                                                                   
...
02502  2150-OUT-AH.                                                     
02503      IF AH-SW = +0   
061008         IF CUR-REC-TYPE = '4' AND WS-PRT-DATA-FILE = 'Y'
061008             MOVE +0 TO DO-AH78
061008                        DO-AHPR
061008                        DO-AHMEAN                                             
061008             WRITE DATA-OUT-REC FROM DATA-OUT-RECORD
061008             PERFORM 3300-INIT-DATA-OUT THRU 3399-EXIT
061008             MOVE 'N' TO WS-PRT-DATA-FILE
061008         END-IF
...
061008     IF CUR-REC-TYPE = '4' AND
061008       WS-PRT-DATA-FILE = 'Y'
061008         MOVE X-P78      TO  DO-AH78
061008         MOVE X-PRATA    TO  DO-AHPR
061008         COMPUTE DO-AHMEAN = (X-P78 + X-PRATA)/2
061008         WRITE DATA-OUT-REC FROM DATA-OUT-RECORD
061008         PERFORM 3300-INIT-DATA-OUT THRU 3399-EXIT
061008         MOVE 'N' TO WS-PRT-DATA-FILE
061008     END-IF.            
...
100208     IF (CUR-REC-TYPE = LOW-VALUES) AND
100208       WS-PRT-DATA-FILE2 = 'Y'
100208         MOVE X-COUNT    TO  DO2-AHINF
100208         MOVE X-WRITTEN  TO  DO2-AHWRIT
100208         MOVE X-P78      TO  DO2-AH78
100208         MOVE X-PRATA    TO  DO2-AHPR
100208         MOVE X-DOMICILE TO  DO2-AHDOMSTAT
100208         MOVE X-STATE    TO  DO2-AHSTSTAT
100208         MOVE X-REMAIN   TO  DO2-AHREMAIN
100208     END-IF.            
02512                                                                   
...
100208     IF (CUR-REC-TYPE = LOW-VALUES) AND 
100208       WS-PRT-DATA-FILE2 = 'Y'
100208         MOVE X-PAID     TO  DO2-LFCOMM
100208         MOVE X-C78      TO  DO2-LFCOMM78
100208         MOVE X-CRATA    TO  DO2-LFCOMMPR
100208         MOVE X-CDOMI    TO  DO2-LFCOMMDOM
100208         MOVE X-TAX      TO  DO2-LFTAX
100208         MOVE X-T78      TO  DO2-LFTAX78
100208         MOVE X-TRATA    TO  DO2-LFTAXPR
100208         MOVE X-TDOMI    TO  DO2-LFTAXDOM
100208     END-IF.                  
02608                                                                   
...
100208         IF (CUR-REC-TYPE = LOW-VALUES) AND 
100208           WS-PRT-DATA-FILE2 = 'Y'
100208             MOVE +0 TO DO2-AHINF
100208                        DO2-AHWRIT
100208                        DO2-AH78
100208                        DO2-AHPR
100208                        DO2-AHDOMSTAT
100208                        DO2-AHSTSTAT
100208                        DO2-AHREMAIN     
100208                        DO2-AHCOMM                                        
100208                        DO2-AHCOMM78
100208                        DO2-AHCOMMPR
100208                        DO2-AHCOMMDOM
100208                        DO2-AHTAX
100208                        DO2-AHTAX78
100208                        DO2-AHTAXPR
100208                        DO2-AHTAXDOM
100208             WRITE DATA-OUT-REC2 FROM DATA-OUT-RECORD2
100208             PERFORM 3400-INIT-DATA-OUT2 THRU 3499-EXIT
100208             MOVE 'N' TO WS-PRT-DATA-FILE2
100208         END-IF
...
100208     IF (CUR-REC-TYPE = LOW-VALUES) AND
100208       WS-PRT-DATA-FILE2 = 'Y'
100208         MOVE X-PAID     TO  DO2-AHCOMM
100208         MOVE X-C78      TO  DO2-AHCOMM78
100208         MOVE X-CRATA    TO  DO2-AHCOMMPR
100208         MOVE X-CDOMI    TO  DO2-AHCOMMDOM
100208         MOVE X-TAX      TO  DO2-AHTAX
100208         MOVE X-T78      TO  DO2-AHTAX78
100208         MOVE X-TRATA    TO  DO2-AHTAXPR
100208         MOVE X-TDOMI    TO  DO2-AHTAXDOM
100208         WRITE DATA-OUT-REC2 FROM DATA-OUT-RECORD2
100208         PERFORM 3400-INIT-DATA-OUT2 THRU 3499-EXIT
100208         MOVE 'N' TO WS-PRT-DATA-FILE2
100208     END-IF.            
...
061008     EXIT.
061008
100208 3400-INIT-DATA-OUT2.
100208     MOVE SPACES TO DO2-CARRIER
100208                    DO2-CERT-GROUP
100208                    DO2-STATE
100208                    DO2-ACCOUNT-NUM
100208                    DO2-ACCOUNT-NAME.
100208
100208          MOVE ZEROS  TO DO2-LFINF
100208                         DO2-LFWRIT
100208                         DO2-LF78
100208                         DO2-LFPR
100208                         DO2-LFDOMSTAT
100208                         DO2-LFSTSTAT
100208                         DO2-LFMORT
100208                         DO2-LFREMAIN
100208                         DO2-AHINF
...
03363                                                                   
111203     IF CLAS-MAXM GREATER +80                                     
111203         MOVE +80  TO  CLAS-MAXM.                                 
03366                                                                   
...
03542                                                                   
03543      CLOSE PRNTR.                              
100208     CLOSE DATA-OUT DATA-OUT2.                   
03544                                                                   

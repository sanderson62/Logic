...
NTTIns     05  AGEB16-LEN       PIC S9(4) COMP.
       ...
       0020-INIT.
           ...
           if dte-client = 'AHL'
              move 'AHO020'            to fd-form-name
           else
              move 'CIO020'            to fd-form-name
           end-if
      ...
      *    move 01                     to fd-form-month
           ...
           if dte-client = 'AHL'
              move 'AHO021'            to fd-form-name
           else
              move 'CIO021'            to fd-form-name
           end-if
           move run-mo                 to fd-form-month
      *    move 01                     to fd-form-month
...
082012        move co-ov120            to pd-ov120
082012     else
082012        MOVE ZEROS               TO PD-OV120
082012     end-if

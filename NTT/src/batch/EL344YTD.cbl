...
00002                                                                   EL344
NTTDel*PROGRAM-ID.                 EL344 .                                 LV009
NTTIns PROGRAM-ID. EL344YTD.
...
062905*        ALSO ADD PROCESSING FOR GAP, CLAIM TYPE 'G'
...
062905 77  TOT-OPEN-GAP           PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  TOT-CLOSED-GAP         PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  EST-TM-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  EST-LM-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  EST-TY-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  DEN-TM-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  DEN-LM-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  DEN-TY-GAP             PIC S9(7)  VALUE ZERO  COMP-3.        EL344
...
062905 77  PAY-TM-GAP             PIC S9(7)V99  VALUE ZERO  COMP-3.     EL344
...
062905 77  PAY-LM-GAP             PIC S9(7)V99  VALUE ZERO  COMP-3.     EL344
...
062905 77  FIN-TM-GAP             PIC S9(7)V99  VALUE ZERO  COMP-3.     EL344
...
062905 77  FIN-LM-GAP             PIC S9(7)V99  VALUE ZERO  COMP-3.     EL344
...
062905     03  HD1-YTD            PIC X(48) VALUE SPACES.
...
00368      05  FILLER               PIC X(41)  VALUE '0'.               EL344
00369      05  TH-AH-OVERRIDE       PIC X(6)   VALUE SPACES.            EL344
00370      05  FILLER               PIC X(10)  VALUE SPACES.            EL344
00371      05  TH-LIFE-OVERRIDE     PIC X(6)   VALUE SPACES.            EL344
122702     05  FILLER               PIC X(10)  VALUE SPACES.            EL344
122702     05  TH-IU-OVERRIDE       PIC X(6)   VALUE SPACES.            EL344
062905     05  FILLER               PIC X(10)  VALUE SPACES.
062905     05  TH-GAP-OVERRIDE      PIC X(6)   VALUE SPACES.
052614     05  FILLER               PIC X(10)  VALUE SPACES.
052614     05  TH-FAM-OVERRIDE      PIC X(6)   VALUE SPACES.
100518     05  FILLER               PIC X(10)  VALUE SPACES.
...
122702     03  TL-MES              PIC X(39).                           EL344
122702     03  FILLER              PIC X(3)  VALUE SPACES.              EL344
122702     03  TL-CNT-AH           PIC ZZZ,ZZ9-.      
00377      03  FILLER              PIC X(7)  VALUE SPACES.              EL344
122702     03  TL-CNT-LIFE         PIC ZZZ,ZZ9-.  
122702     03  FILLER              PIC X(7)  VALUE SPACES.              EL344
122702     03  TL-CNT-IU           PIC ZZZ,ZZ9-.  
062905     03  FILLER              PIC X(7)  VALUE SPACES.
062905     03  TL-CNT-GAP          PIC ZZZ,ZZ9-.
052614     03  FILLER              PIC X(7)  VALUE SPACES.
052614     03  TL-CNT-FAM          PIC ZZZ,ZZ9-.
100518     03  FILLER              PIC X(7)  VALUE SPACES.
...
00381      03  TL-MESA             PIC X(35).                           EL344
00382      03  FILLER              PIC X(2)  VALUE SPACES.              EL344
00383      03  TL-AMT-AH           PIC Z,ZZZ,ZZZ.99-.                   EL344
00384      03  FILLER              PIC X(2)  VALUE SPACES.              EL344
00385      03  TL-AMT-LIFE         PIC Z,ZZZ,ZZZ.99-.                   EL344
00384      03  FILLER              PIC X(2)  VALUE SPACES.              EL344
00385      03  TL-AMT-IU           PIC Z,ZZZ,ZZZ.99-.                   EL344
062905     03  FILLER              PIC X(2)  VALUE SPACES.
062905     03  TL-AMT-GAP          PIC Z,ZZZ,ZZZ.99-.
052614     03  FILLER              PIC X(2)  VALUE SPACES.
052614     03  TL-AMT-FAM          PIC Z,ZZZ,ZZZ.99-.
100518     03  FILLER              PIC X(2)  VALUE SPACES.
100518     03  TL-AMT-OTH          PIC Z,ZZZ,ZZZ.99-.
...
062905         WHEN CL-CLAIM-TYPE = 'G'
062905             ADD +1  TO  EST-TM-GAP
052614
...
122702     WHEN CL-CLAIM-TYPE = 'G' AND
122702          CLAIM-IS-OPEN
122702         ADD +1  TO  TOT-OPEN-GAP

122702     WHEN CL-CLAIM-TYPE = 'G' AND
122702          CLAIM-IS-CLOSED
122702         ADD +1  TO  TOT-CLOSED-GAP
052614
...
062905     WHEN ST-CLMTYP = 'G'         
062905         MOVE 'GAP   '         TO DET-TYPE
052614
...
062905         WHEN ST-CLMTYP = 'G'
062905             ADD AT-AMOUNT-PAID TO PAY-TM-GAP
052614
052614         WHEN ST-CLMTYP = 'F'
...
062905         WHEN ST-CLMTYP = 'G'
062905             ADD AT-AMOUNT-PAID TO PAY-LM-GAP
052614
052614         WHEN ST-CLMTYP = 'F'
...
062905             WHEN ST-CLMTYP = 'G'
062905                 ADD AT-AMOUNT-PAID TO FIN-TM-GAP
052614
052614             WHEN ST-CLMTYP = 'F'
...
122702                 WHEN ST-CLMTYP = 'G'
122702                     ADD AT-AMOUNT-PAID TO FIN-LM-GAP
052614
052614                 WHEN ST-CLMTYP = 'F'

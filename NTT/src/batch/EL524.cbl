...
00130
       01  P pointer.
       01  DDSYS010.
           05  FILLER PIC x(9) value 'DD_SYS010'.
...
pemuni 01  dsn-name-buff                   pic x(100).
                                                                        EL524
00389  EJECT                                                            EL524
...
00421  1000-MAIN-LOGIC SECTION.
                                                                        EL524
NTTins     set P to address of DDSYS010
NTTins     call "getenv" using by value P returning var-ptr
NTTins     if var-ptr = null
NTTins        display 'DD_SYS010 not set '
NTTins     else
NTTins        set address of dsn-name-buff to var-ptr
NTTins        move 0 to env-var-len
NTTins        inspect dsn-name-buff tallying env-var-len
NTTins           for characters before X'00'
NTTins        display 'dd sys010=' dsn-name-buff(1:env-var-len)
NTTins     end-if

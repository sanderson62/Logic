...
022122     05  WS-DLY-BRV-CLMS-PD-CNT      PIC S9(06)    VALUE +0.
022122     05  WS-DLY-HOS-CLMS-PD-CNT      PIC S9(06)    VALUE +0.
...
022122     05  WS-DLY-BRV-DRFTS-CNT        PIC S9(06)    VALUE +0.
022122     05  WS-DLY-HOS-DRFTS-CNT        PIC S9(06)    VALUE +0.
...
022122     05  WS-DLY-BRV-VOID-CNT         PIC S9(06)    VALUE +0.
022122     05  WS-DLY-HOS-VOID-CNT         PIC S9(06)    VALUE +0.
...
022122     05  WS-DLY-BRV-OFFLN-CNT        PIC S9(06)    VALUE +0.
022122     05  WS-DLY-HOS-OFFLN-CNT        PIC S9(06)    VALUE +0.
...
022122     05  WS-TOT-BRV-CLMS-PD-CNT      PIC S9(06)    VALUE +0.
022122     05  WS-TOT-HOS-CLMS-PD-CNT      PIC S9(06)    VALUE +0.
...
022122     05  WS-TOT-BRV-DRFTS-CNT        PIC S9(06)    VALUE +0.
022122     05  WS-TOT-HOS-DRFTS-CNT        PIC S9(06)    VALUE +0.
...
022122     05  WS-TOT-BRV-VOID-CNT         PIC S9(06)    VALUE +0.
022122     05  WS-TOT-HOS-VOID-CNT         PIC S9(06)    VALUE +0.
...
022122     05  WS-TOT-BRV-OFFLN-CNT        PIC S9(06)    VALUE +0.
022122     05  WS-TOT-HOS-OFFLN-CNT        PIC S9(06)    VALUE +0.
...
022122     05  WS-DLY-BRV-CLMS-PD-AMT      PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-BRV-VOID-AMT         PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-BRV-OFFLN-AMT        PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-BRV-NETPD-AMT        PIC S9(08)V99 VALUE +0.

022122     05  WS-DLY-HOS-CLMS-PD-AMT      PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-HOS-VOID-AMT         PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-HOS-OFFLN-AMT        PIC S9(08)V99 VALUE +0.
022122     05  WS-DLY-HOS-NETPD-AMT        PIC S9(08)V99 VALUE +0.
...
022122     05  WS-TOT-BRV-CLMS-PD-AMT      PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-BRV-VOID-AMT         PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-BRV-OFFLN-AMT        PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-BRV-NETPD-AMT        PIC S9(08)V99 VALUE +0.

022122     05  WS-TOT-HOS-CLMS-PD-AMT      PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-HOS-VOID-AMT         PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-HOS-OFFLN-AMT        PIC S9(08)V99 VALUE +0.
022122     05  WS-TOT-HOS-NETPD-AMT        PIC S9(08)V99 VALUE +0.
...
022122
022122         IF MONTH-TO-DATE
022122             CONTINUE
022122         ELSE
022122             MOVE WS-DRFTLST-STOP-PAY-AMT  TO WS-DRFTLST-DRFTAMT
022122             MOVE 'STOP-PAY'               TO
022122                                           WS-DRFTLST-ENTRY-TYPE
022122             PERFORM 2400-DAILY-DRAFT-LIST THRU 2400-EXIT
022122
022122************** ACCUMULATE CURRENT CYCLE DAY TOTALS HERE AND GO ON
022122*              TO ADD THESE FIGURES TO MTD TOTALS
022122             ADD AT-AMOUNT-PAID          TO WS-DLY-BRV-VOID-AMT
022122             ADD +1                      TO WS-DLY-BRV-VOID-CNT
022122             ADD WS-DRFTLST-STOP-PAY-AMT TO WS-DLY-BRV-NETPD-AMT
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID               TO WS-TOT-BRV-VOID-AMT
022122         ADD +1                           TO WS-TOT-BRV-VOID-CNT
022122         ADD WS-DRFTLST-STOP-PAY-AMT      TO WS-TOT-BRV-NETPD-AMT
022122
...
022122************** ACCUMULATE CURRENT CYCLE DAY TOTALS HERE AND GO ON
022122*              TO ADD THESE FIGURES TO MTD TOTALS
022122             ADD AT-AMOUNT-PAID          TO WS-DLY-HOS-VOID-AMT
022122             ADD +1                      TO WS-DLY-HOS-VOID-CNT
022122             ADD WS-DRFTLST-STOP-PAY-AMT TO WS-DLY-HOS-NETPD-AMT
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID               TO WS-TOT-HOS-VOID-AMT
022122         ADD +1                           TO WS-TOT-HOS-VOID-CNT
022122         ADD WS-DRFTLST-STOP-PAY-AMT      TO WS-TOT-HOS-NETPD-AMT
022122
...
022122             CONTINUE
022122         ELSE
022122             MOVE AT-AMOUNT-PAID      TO WS-DRFTLST-DRFTAMT
022122             MOVE 'OFFLINE'           TO WS-DRFTLST-ENTRY-TYPE
022122             PERFORM 2400-DAILY-DRAFT-LIST THRU 2400-EXIT
022122
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-BRV-OFFLN-AMT
022122             ADD +1                   TO WS-DLY-BRV-OFFLN-CNT
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-BRV-NETPD-AMT
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-BRV-OFFLN-AMT
022122         ADD +1                       TO WS-TOT-BRV-OFFLN-CNT
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-BRV-NETPD-AMT
022122
022122     WHEN AT-CLAIM-TYPE = 'H'
022122
022122         IF MONTH-TO-DATE
...
022122             PERFORM 2400-DAILY-DRAFT-LIST THRU 2400-EXIT
022122
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-HOS-OFFLN-AMT
022122             ADD +1                   TO WS-DLY-HOS-OFFLN-CNT
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-HOS-NETPD-AMT
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-HOS-OFFLN-AMT
022122         ADD +1                       TO WS-TOT-HOS-OFFLN-CNT
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-HOS-NETPD-AMT
022122
100518     WHEN AT-CLAIM-TYPE = 'O'
100518
100518         IF MONTH-TO-DATE
...
022122         ELSE
022122             MOVE AT-AMOUNT-PAID      TO WS-DRFTLST-DRFTAMT
022122             MOVE 'ONLINE'            TO WS-DRFTLST-ENTRY-TYPE
022122             PERFORM 2400-DAILY-DRAFT-LIST THRU 2400-EXIT
022122
022122************** ACCUMULATE CURRENT CYCLE DAY TOTALS HERE AND GO ON
022122*              TO ADD THESE FIGURES TO MTD TOTALS ALSO
022122             IF CLAIM-NOT-COUNTED
022122                 ADD +1               TO WS-DLY-BRV-CLMS-PD-CNT
022122             END-IF
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-BRV-CLMS-PD-AMT
022122             ADD +1                   TO WS-DLY-BRV-DRFTS-CNT
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-BRV-NETPD-AMT
022122         END-IF
022122
022122
022122         IF (CLAIM-NOT-COUNTED AND
022122             STOP-PAY-SW-OFF)
022122             ADD +1                   TO WS-TOT-BRV-CLMS-PD-CNT
022122             ADD +1                   TO WS-GRAND-TOT-CLMS-PD-CNT
022122             SET CLAIM-COUNTED        TO TRUE
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-BRV-CLMS-PD-AMT
022122         ADD +1                       TO WS-TOT-BRV-DRFTS-CNT
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-BRV-NETPD-AMT
022122
022122     WHEN AT-CLAIM-TYPE = 'H'
022122  
...
022122*              TO ADD THESE FIGURES TO MTD TOTALS ALSO
022122             IF CLAIM-NOT-COUNTED
022122                 ADD +1               TO WS-DLY-HOS-CLMS-PD-CNT
022122             END-IF
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-HOS-CLMS-PD-AMT
022122             ADD +1                   TO WS-DLY-HOS-DRFTS-CNT
022122             ADD AT-AMOUNT-PAID       TO WS-DLY-HOS-NETPD-AMT
022122         END-IF
022122
022122
022122         IF (CLAIM-NOT-COUNTED AND
022122             STOP-PAY-SW-OFF)
022122             ADD +1                   TO WS-TOT-HOS-CLMS-PD-CNT
022122             ADD +1                   TO WS-GRAND-TOT-CLMS-PD-CNT
022122             SET CLAIM-COUNTED        TO TRUE
022122         END-IF
022122
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-HOS-CLMS-PD-AMT
022122         ADD +1                       TO WS-TOT-HOS-DRFTS-CNT
022122         ADD AT-AMOUNT-PAID           TO WS-TOT-HOS-NETPD-AMT
022122
100518     WHEN AT-CLAIM-TYPE = 'O'
100518
...
062314         PERFORM 3900-WRITE           THRU 3900-EXIT
062314
022122************ SUMMARY LINE FOR BRV (BEREAVEMENT ) DAILY 
022122         MOVE WS-EDITED-CYCLE-DT      TO WS-BRV-LABEL-VAR
022122         MOVE WS-FULL-BRV-LABEL       TO WS-SUMMARY-LABEL
022122         MOVE WS-DLY-BRV-CLMS-PD-AMT  TO WS-SUMMARY-TOT-PD-AMT
022122         MOVE WS-DLY-BRV-CLMS-PD-CNT  TO WS-SUMMARY-CLAIMS-PD-CNT
022122         MOVE WS-DLY-BRV-DRFTS-CNT    TO WS-SUMMARY-DRAFT-CNT
022122         MOVE WS-DLY-BRV-VOID-AMT     TO WS-SUMMARY-TOT-VOID-AMT
022122         MOVE WS-DLY-BRV-VOID-CNT     TO WS-SUMMARY-VOID-CNT
022122         MOVE WS-DLY-BRV-OFFLN-AMT    TO WS-SUMMARY-OFFLINE-AMT
022122         MOVE WS-DLY-BRV-OFFLN-CNT    TO WS-SUMMARY-OFFLINE-CNT
022122         MOVE WS-DLY-BRV-NETPD-AMT    TO WS-SUMMARY-NETPD-AMT
022122
022122         MOVE WS-SUMMARY-LINEX        TO PRT
022122         MOVE '-'                     TO P-CTL
022122         PERFORM 3900-WRITE           THRU 3900-EXIT
022122
022122         INITIALIZE WS-SUMMARY-LINEX
022122************ SUMMARY LINE FOR BRV (BEREAVEMENT ) MTD
022122         MOVE SPACES                  TO WS-BRV-LABEL-VAR
022122         MOVE WS-MTD-LITERAL          TO WS-BRV-LABEL
022122         MOVE WS-FULL-BRV-LABEL       TO WS-SUMMARY-LABEL
022122         MOVE WS-TOT-BRV-CLMS-PD-AMT  TO WS-SUMMARY-TOT-PD-AMT
022122         MOVE WS-TOT-BRV-CLMS-PD-CNT  TO WS-SUMMARY-CLAIMS-PD-CNT
022122         MOVE WS-TOT-BRV-DRFTS-CNT    TO WS-SUMMARY-DRAFT-CNT
022122         MOVE WS-TOT-BRV-VOID-AMT     TO WS-SUMMARY-TOT-VOID-AMT
022122         MOVE WS-TOT-BRV-VOID-CNT     TO WS-SUMMARY-VOID-CNT
022122         MOVE WS-TOT-BRV-OFFLN-AMT    TO WS-SUMMARY-OFFLINE-AMT
022122         MOVE WS-TOT-BRV-OFFLN-CNT    TO WS-SUMMARY-OFFLINE-CNT
022122         MOVE WS-TOT-BRV-NETPD-AMT    TO WS-SUMMARY-NETPD-AMT
022122
022122         MOVE WS-SUMMARY-LINEX        TO PRT
022122         PERFORM 3900-WRITE           THRU 3900-EXIT
022122
022122************ SUMMARY LINE FOR HOS (HOSPITAL    ) DAILY 
022122         MOVE WS-EDITED-CYCLE-DT      TO WS-HOS-LABEL-VAR
022122         MOVE WS-FULL-HOS-LABEL       TO WS-SUMMARY-LABEL
022122         MOVE WS-DLY-HOS-CLMS-PD-AMT  TO WS-SUMMARY-TOT-PD-AMT
022122         MOVE WS-DLY-HOS-CLMS-PD-CNT  TO WS-SUMMARY-CLAIMS-PD-CNT
022122         MOVE WS-DLY-HOS-DRFTS-CNT    TO WS-SUMMARY-DRAFT-CNT
022122         MOVE WS-DLY-HOS-VOID-AMT     TO WS-SUMMARY-TOT-VOID-AMT
022122         MOVE WS-DLY-HOS-VOID-CNT     TO WS-SUMMARY-VOID-CNT
022122         MOVE WS-DLY-HOS-OFFLN-AMT    TO WS-SUMMARY-OFFLINE-AMT
022122         MOVE WS-DLY-HOS-OFFLN-CNT    TO WS-SUMMARY-OFFLINE-CNT
022122         MOVE WS-DLY-HOS-NETPD-AMT    TO WS-SUMMARY-NETPD-AMT
022122
022122         MOVE WS-SUMMARY-LINEX        TO PRT
022122         MOVE '-'                     TO P-CTL
022122         PERFORM 3900-WRITE           THRU 3900-EXIT
...
022122
022122         INITIALIZE WS-SUMMARY-LINEX
022122************ SUMMARY LINE FOR HOS (HOSPITAL    ) MTD
022122         MOVE SPACES                  TO WS-HOS-LABEL-VAR
022122         MOVE WS-MTD-LITERAL          TO WS-HOS-LABEL
022122         MOVE WS-FULL-HOS-LABEL       TO WS-SUMMARY-LABEL
022122         MOVE WS-TOT-HOS-CLMS-PD-AMT  TO WS-SUMMARY-TOT-PD-AMT
022122         MOVE WS-TOT-HOS-CLMS-PD-CNT  TO WS-SUMMARY-CLAIMS-PD-CNT
022122         MOVE WS-TOT-HOS-DRFTS-CNT    TO WS-SUMMARY-DRAFT-CNT
022122         MOVE WS-TOT-HOS-VOID-AMT     TO WS-SUMMARY-TOT-VOID-AMT
022122         MOVE WS-TOT-HOS-VOID-CNT     TO WS-SUMMARY-VOID-CNT
022122         MOVE WS-TOT-HOS-OFFLN-AMT    TO WS-SUMMARY-OFFLINE-AMT
022122         MOVE WS-TOT-HOS-OFFLN-CNT    TO WS-SUMMARY-OFFLINE-CNT
022122         MOVE WS-TOT-HOS-NETPD-AMT    TO WS-SUMMARY-NETPD-AMT
022122
022122         MOVE WS-SUMMARY-LINEX        TO PRT
022122         PERFORM 3900-WRITE           THRU 3900-EXIT
022122

...
00023                                                                   
00024 *REMARKS.                                                         
00025 *        TRANSACTION - EXB1 - NEW BUSINESS, REVIEW AND CORRECTION 
...
010517* 010517  CR2016021600005  PEMA  ADD NEW FORCE CD FOR AGG
022017* 022017  IR2017022000002  PEMA  PREVENT DEL OF ISS W/CHECK
101016* 101016  CR2015082500001  PEMA  ADD COMPANY VPP
...
012220* 012220  CR2018092700002  TANA  Add letter reqd field
012820* 012820  CR2020012800001  PEMA  Addd minimum term edit for extd trm
...
052020* 052020  CR2019111300001  PEMA  Include all files in "K" trans
072120* 072120  CR2020072100002  PEMA  Allow deletion of dup pend iss rec
...
00036  77  FILLER  PIC X(32)  VALUE '*    EL6311 WORKING STORAGE    *'. 
...
022017 77  ws-any-check-sw             pic x value ' '.
022017     88  i-have-a-check-period      value 'Y'.
...
00054      12  EL631B                  PIC X(8)    VALUE 'EL631B'.      
00055      12  EL631C                  PIC X(8)    VALUE 'EL631C'.      
00056      12  EL631D                  PIC X(8)    VALUE 'EL631D'.      
00057      12  MAPSET-EL6311S          PIC X(8)    VALUE 'EL6311S'.     
00058      12  SCREEN-NUMBER           PIC X(6)    VALUE 'EL631B'.      
00059      12  TRANS-EXB1              PIC X(4)    VALUE 'EXB1'.        
00060      12  THIS-PGM                PIC X(8)    VALUE 'EL6311'.      
...
041320         16  ernote-record-type      pic x        value spaces.
00174                                                                   
...
052918     12  ERACNT-KEY.
052918         16  ERACNT-COMPANY-CD          PIC  X.
052918         16  ERACNT-CARRIER             PIC  X.
052918         16  ERACNT-GROUPING            PIC  X(6).
052918         16  ERACNT-STATE               PIC  XX.
052918         16  ERACNT-ACCOUNT             PIC  X(10).
052918         16  ERACNT-REC-TYPE            PIC  X.
052918         16  ERACNT-SEQ-NO              PIC  S9(4) COMP.
...
052020 01  EL055-PASS-AREA.
052020     05  PA-CURRENT-KEY          PIC X(11).
052020     05  PA-NEW-ALT-KEY          PIC X(36).
052020     05  PA-RETURN-AREA.
052020         10  ra-status-code      pic 9(4).
052020         10  ra-message          pic x(205).
...
021519         88 WS-MODE-CODE-VALID     VALUE ' '
021519                                         'W'     *> Weekly
021519                                         'B'     *> Bi-weekly
021519                                         'S'     *> Semi-monthly
021519                                         'M'     *> Monthly (Def)
021519                                         'Q'     *> Quarterly
021519                                         'N'     *> Bi-Monthly??
021519                                         'T'     *> Semi-annual
021519                                         'A'.    *> Annual Pay
00261                                                                   
...
00269                                  PIC X.                           
012220     12  WS-SAVE-PEND-ISSUE          PIC X(375).
012220     12  WS-ARCHIVE-LETTER-SW    PIC X    VALUE 'N'.
012220        88  ARCHIVE-LETTER-RELEASED   VALUE 'Y'.
012220        88  CALLED-FROM-6315          VALUE '5'.
00270                                                                   
...
052020     12  er-0229                 pic  9(4) value 0229.
...
012220     12  ER-1577                 PIC  9(4) VALUE 1577.
012220     12  ER-1584                 PIC  9(4) VALUE 1584.
012220     12  ER-1585                 PIC  9(4) VALUE 1585.
070622     12  ER-1590                 PIC  9(4) VALUE 1590.
070622     12  ER-1591                 PIC  9(4) VALUE 1591.
072312     12  ER-1609                 PIC  9(4) VALUE 1609.
052918     12  er-1762                 pic  9(4) value 1762.
...
00591      12  ER-2651                 PIC  9(4) VALUE 2651.
...
052020     12  er-2878                 pic  9(4) value 2878.
...
012820     12  er-3070                 pic  9(4) value 3070.
...
052419     12  er-9853                 pic  9(4) value 9853.
00671                                                                   
...
00688      COPY ELC631PI.                                               
020218        16  pi-6311-fatal-ctr    pic s999 comp-3.
00689         16  FILLER             PIC X(92).                        
00690                                                                   
...
00725      COPY EL6311S.                                                
00726      EJECT                                                        
00727  01  MAP-B REDEFINES EL631BI.                                     
012220     12  FILLER                  PIC X(595).
121712*    12  FILLER                  PIC X(591).
...
00840      MOVE LOW-VALUES             TO EL631BI.                      
00841                                                                   
...
00865                                                                   
00866          ELSE                                                     
012220             IF PI-CALLING-PROGRAM = 'EL6315'
012220                SET CALLED-FROM-6315 TO TRUE
012220             END-IF
...
00954                                                                   
00955      INSPECT EL631BI CONVERTING '_' TO ' '.                       
00956                                                                   
00957      IF PI-MAP-NAME = EL631B                                      
...
01026                                                                   
01027      IF PI-MAP-NAME = EL631B                                      
01028         GO TO 0300-CHECK-ISSUE-PF-KEYS.                           
01029                                                                   
01030      IF PI-MAP-NAME = EL631C                                      
01031         GO TO 0400-CHECK-CANCEL-PF-KEYS.                          
01032                                                                   
01033      IF PI-MAP-NAME = EL631D                                      
...
020218*       AND (FATAL-ERRORS)
020218        and (pi-6311-fatal-ctr <> +0)
...
090612*        ELSE                                                      
090612*           MOVE EL631B              TO PI-MAP-NAME                
090612*           MOVE LOW-VALUES          TO EL631BI                    
...
090612*              NEXT SENTENCE                                          
090612*           ELSE                                                      
090612*              MOVE EL631C        TO PI-MAP-NAME                
090612*              MOVE LOW-VALUES    TO EL631CI                    
...
090612*           END-IF
              ELSE
                 PERFORM 5100-PROCESS-POL-RESC
                                       THRU 5100-EXIT
020218           MOVE  PI-PREV-CONTROL-PRIMARY
020218                                 TO ERPNDB-KEY
020218           EXEC CICS READ
020218               SET     (ADDRESS OF PENDING-BUSINESS)
020218               DATASET (FILE-ID-ERPNDB)
020218               RIDFLD  (ERPNDB-KEY)
                     resp    (WS-RESPONSE)
020218           END-EXEC
020218           PERFORM 9800-LINK-PENDING-EDIT
020218                                 THRU 9800-EXIT

080522           MOVE  PI-PREV-CONTROL-PRIMARY
080522                                 TO ERPNDB-KEY
080522           move cg-batch-seq-no  to ERPNDB-BATCH-SEQ-NO
080522           EXEC CICS READ
080522               SET     (ADDRESS OF PENDING-BUSINESS)
080522               DATASET (FILE-ID-ERPNDB)
080522               RIDFLD  (ERPNDB-KEY)
080522               resp    (WS-RESPONSE)
080522           END-EXEC
080522
080522           PERFORM 9800-LINK-PENDING-EDIT
080522                                 THRU 9800-EXIT
...
041320           move ERPNDB-RECORD-TYPE to pi-program-work-area(1:1)
...
102020         move '1'                to PI-689-CHG-SEQ-NOX
...
102020         move '2'                to PI-689-CHG-SEQ-NOX
...
012220
012220     EXEC CICS READ
pemins         set     (address of pending-business)
012220         DATASET (FILE-ID-ERPNDB)
pemcom*        INTO    (PENDING-BUSINESS)
012220         RIDFLD  (PI-PREV-CONTROL-PRIMARY)
012220     END-EXEC.
01729                                                                   
...
101706     END-IF
012220
012220     IF LETRREQL   GREATER THAN ZEROS
012220        IF LETRREQI = 'Y'
012220          AND (PB-I-LETTER-REQD = 'Y' OR 'N')
012220           CONTINUE
012220        ELSE
012220        IF LETRREQI = 'N'
012220          AND (PB-I-LETTER-REQD = 'Y' OR 'N')
012220           CONTINUE
012220        ELSE
012220           MOVE -1               TO LETRREQL
012220           MOVE ER-1585          TO EMI-ERROR
012220           MOVE AL-UABON         TO LETRREQA
012220           PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT
012220        END-IF
012220     END-IF.
...
01869                                                                   
01870      IF B1STPMTL NOT = ZEROS                                      
01871         IF B1STPMTI = SPACES                                      
01872            MOVE LOW-VALUES           TO WS-CONVERTED-1ST-PMT-DT   
01873         ELSE                                                      
01874            MOVE B1STPMTI             TO DEEDIT-FIELD              
01875            PERFORM 8600-DEEDIT                                    
01876            MOVE DEEDIT-FIELD-V0      TO DC-GREG-DATE-1-MDY        
01877            MOVE AL-UNNON             TO B1STPMTA                  
01878            MOVE 4                    TO DC-OPTION-CODE            
01879            PERFORM 9700-DATE-LINK                                 
01880            IF NO-CONVERSION-ERROR                                 
01881               MOVE DC-BIN-DATE-1     TO WS-CONVERTED-1ST-PMT-DT   
01882               MOVE AL-UANON          TO B1STPMTA                  
01883            ELSE                                                   
01884               MOVE -1                TO B1STPMTL                  
01885               MOVE  1                TO SET-CURSOR-SW             
01886               MOVE ER-2200           TO EMI-ERROR                 
01887               MOVE AL-UNBON          TO B1STPMTA                  
01888               PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.           
01889                                                                   
01890      IF BDAYSL NOT = ZEROS                                        
01891          IF BDAYSI NUMERIC                                        
01892              MOVE AL-UNNON           TO BDAYSA                    
01893          ELSE                                                     
01894              MOVE -1                 TO BDAYSL                    
01895              MOVE ER-2530            TO EMI-ERROR                 
01896              MOVE AL-UNBON           TO BDAYSA                    
01897              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
01898                                                                   
01899      IF BLNTRML NOT = ZEROS                                       
01900          IF BLNTRMI NUMERIC                                       
01901              MOVE AL-UNNON       TO BLNTRMA                       
01902          ELSE                                                     
01903              MOVE -1             TO BLNTRML                       
01904              MOVE ER-2533        TO EMI-ERROR                     
01905              MOVE AL-UNBON       TO BLNTRMA                       
01906              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
01907                                                                   
...
01922                                                                   
01923      IF BFREQL NOT = ZEROS                                        
01924          IF BFREQI NUMERIC                                        
01925              MOVE AL-UNNON       TO BFREQA                        
01926          ELSE                                                     
01927              MOVE -1             TO BFREQL                        
01928              MOVE  1             TO SET-CURSOR-SW                 
01929              MOVE ER-2223        TO EMI-ERROR                     
01930              MOVE AL-UNBON       TO BFREQA                        
01931              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
01932                                                                   
01933      IF BMODEL NOT = ZEROS                                        
01934          MOVE BMODEI             TO WS-MODE-CODE                  
01935                                     PI-BMODE                      
01936          IF WS-MODE-CODE-VALID                                    
01937              MOVE AL-UANON       TO BMODEA                        
01938          ELSE                                                     
01939              MOVE -1             TO BMODEL                        
01940              MOVE ER-2591        TO EMI-ERROR                     
01941              MOVE AL-UABON       TO BMODEA                        
01942              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
01943                                                                   
01944      IF BPMTSL NOT = ZEROS                                        
01945          IF BPMTSI NUMERIC                                        
01946              MOVE AL-UNNON           TO BPMTSA                    
01947              MOVE BPMTSI             TO PI-BPMTS                  
01948          ELSE                                                     
01949              MOVE -1                 TO BPMTSL                    
01950              MOVE ER-2592            TO EMI-ERROR                 
01951              MOVE AL-UNBON           TO BPMTSA                    
01952              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
01953                                                                   
01954      IF BPMTAMTL NOT = ZEROS                                      
CIDMOD        EXEC CICS BIF DEEDIT
CIDMOD             FIELD  (BPMTAMTI)
CIDMOD             LENGTH (9)
CIDMOD        END-EXEC
CIDMOD        MOVE BPMTAMTI           TO PI-BPMTAMT.

CIDMOD*        MOVE BPMTAMTI           TO DEEDIT-FIELD-V2               
CIDMOD*        PERFORM 8600-DEEDIT                                      
CIDMOD*        MOVE DEEDIT-FIELD-V2    TO PI-BPMTAMT.                   
01960                                                                   
01961 *    IF BAPRL NOT = ZEROS                                         
01962 *        EXEC CICS BIF DEEDIT                                     
01963 *            FIELD  (BAPRI)                                       
01964 *            LENGTH (7)                                           
01965 *        END-EXEC                                                 
01966 *        MOVE BAPRI              TO WS-BAPR.                      
01967                                                                   

02164      IF BAPRL > 0
032210        MOVE +0                  TO  WS-BAPR
032210        PERFORM VARYING WS-SUB FROM +1 BY +1 UNTIL
032210           (WS-SUB > 7)
032210           OR (BAPRI (WS-SUB:1) NUMERIC)
032210           OR (BAPRI (WS-SUB:1) = '.')
032210        END-PERFORM
032210        IF WS-SUB > 7
032210           MOVE ER-2471       TO EMI-ERROR                     
032210           MOVE -1            TO BAPRL
032210           MOVE AL-UNBON      TO BAPRA
032210           PERFORM 9900-ERROR-FORMAT
032210                                 THRU 9900-EXIT
032210        ELSE
032210           IF BAPRI (WS-SUB:1) NUMERIC
032210              MOVE WS-SUB           TO WS-BEG
032210              PERFORM VARYING WS-SUB FROM WS-SUB BY +1 UNTIL
032210                 (WS-SUB > 7)
032210                 OR (BAPRI (WS-SUB:1) NOT NUMERIC)
032210              END-PERFORM
032210              COMPUTE WS-END = WS-SUB - WS-BEG
032210              MOVE BAPRI (WS-BEG:WS-END)
032210                                 TO WS-APR-WHOLE-NUM
032210           END-IF
032210           IF BAPRI (WS-SUB:1) = '.'
032210              COMPUTE WS-BEG = WS-SUB + 1
032210              IF (WS-BEG < 8)
032210                 AND (BAPRI (WS-BEG:1) NUMERIC)
032210                 PERFORM VARYING WS-SUB FROM WS-BEG BY +1 UNTIL
032210                    (WS-SUB > 7)
032210                    OR (BAPRI (WS-SUB:1) NOT NUMERIC)
032210                 END-PERFORM
032210                 COMPUTE WS-END = WS-SUB - WS-BEG
032210                 MOVE BAPRI (WS-BEG:WS-END)
032210                                 TO WS-APR-DEC (1:WS-END)
032210              END-IF
032210           END-IF
032210           MOVE AL-UNNON      TO BAPRA
032210           MOVE WS-BAPR       TO BAPRO
032210        END-IF
032210     END-IF

PEMMOD*     IF BAPRL NOT = ZEROS                                        
PEMMOD*        MOVE BAPRI              TO DEEDIT-FIELD-V4               
PEMMOD*        PERFORM 8600-DEEDIT                                      
PEMMOD*        MOVE DEEDIT-FIELD-V4    TO WS-BAPR.                      
01967                                                                   
01968      IF BLIVESL NOT = ZEROS                                       
CIDMOD        MOVE BLIVESI             TO DEEDIT-FIELD                  
CIDMOD        PERFORM 8600-DEEDIT                                       
CIDMOD        IF DEEDIT-FIELD-V0 NUMERIC                                
CIDMOD           MOVE DEEDIT-FIELD-V0  TO WS-BLIVES                     
01979            MOVE AL-UNNON         TO BLIVESA                       
01980         ELSE                                                      
01981            MOVE -1               TO BLIVESL                       
01982            MOVE AL-UNBON         TO BLIVESA                       
CIDMOD           MOVE ER-2223          TO EMI-ERROR                     
01984            PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.              
01985                                                                   
01986 *DMD CUSTOM CODING*************START                              
01987 *NOTE PI-I-NUM-BILLED IS A FIELD FOR 'DMD' ONLY                   
01988      IF PI-COMPANY-ID NOT = 'DMD'                                 
01989          MOVE ZEROS               TO BBILLEDL                     
01990          GO TO 1010-EDIT-CONT.                                    
01991                                                                   
01992      IF BBILLEDL NOT = ZEROS                                      
01993         MOVE BBILLEDI            TO WS-EDIT-CSO-FIELD             
01994         MOVE 'Y'                 TO WS-NUMERIC-SW                 
01995         MOVE +1                  TO WS-CSO-SUB                    
01996         PERFORM 1030-EDIT-FOR-NUMERICS THRU 1030-EDIT-EXIT        
01997         IF CSO-NUMERIC-FIELD                                      
01998            EXEC CICS BIF DEEDIT                                   
01999                FIELD  (BBILLEDI)                                  
02000                LENGTH (9)                                         
02001            END-EXEC                                               
02002            MOVE BBILLEDI         TO WS-BILLED                     
02003            MOVE AL-UNNON         TO BBILLEDA                      
02004         ELSE                                                      
02005            MOVE -1               TO BBILLEDL                      
02006            MOVE AL-UNBON         TO BBILLEDA                      
02007            MOVE ER-2547          TO EMI-ERROR                     
02008            PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT               
02009      ELSE                                                         
02010         IF BMAINTI EQUAL 'A'                                      
02011            MOVE -1               TO BBILLEDL                      
02012            MOVE AL-UNBON         TO BBILLEDA                      
02013            MOVE ER-8148          TO EMI-ERROR                     
...
02026                                                                   
010517     if (bforcel not = zeros)
010517        and (bforcei = 'L')
010517        and (not csr-edit-session)
010517        and (emi-error <> er-2945)
010517        MOVE ER-2670             TO EMI-ERROR                 
010517        MOVE AL-UABON            TO BFORCEA                   
010517        MOVE -1                  TO BFORCEL                   
010517        PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT
010517     end-if
...
091615        GO TO 1025-EDIT-CONTINUE
           END-IF
02092                                                                   
02093      IF PI-COMPANY-ID = CLIENT-CRI OR CLIENT-LGX                  
02094        IF (BMODEL   GREATER ZERO  OR                              
02095             BPMTSL   GREATER ZERO  OR                             
02096             BPMTAMTL GREATER ZERO)                                
02097           AND                                                     
02098             BTYPE-LEN (WS-SUB1) GREATER THAN +0                   
02099                GO TO 1021-CONT-EDIT.                              
02100                                                                   
...
02134                                                                   
02135      IF PI-COMPANY-ID NOT = CLIENT-CRI AND CLIENT-LGX             
02136 *      IF BTERM-LEN (WS-SUB1) NOT GREATER THAN +0                 
02137         IF BMODEL  GREATER THAN ZEROS  AND                        
02138            BPMTSL  GREATER THAN ZEROS                             
02139            PERFORM 6100-TERM-CONVERSION THRU 6199-EXIT.
02140                                                                   
02141      IF PI-COMPANY-ID = CLIENT-CRI OR CLIENT-LGX                  
02142          IF BMODEL   GREATER THAN ZEROS  OR                       
02143             BPMTSL   GREATER THAN ZEROS  OR                       
02144             BPMTAMTL GREATER THAN ZEROS                           
02145              PERFORM 6100-TERM-CONVERSION THRU 6199-EXIT.         
02146                                                                   
...
02189 *    IF PI-COMPANY-ID NOT = CLIENT-CRI AND CLIENT-LGX             
02190 *        IF BMODEL  GREATER THAN ZEROS  AND                       
02191 *           BPMTSL  GREATER THAN ZEROS                            
02192 *            PERFORM 6100-TERM-CONVERSION THRU 6199-EXIT.         
02193                                                                   
...
052020**  This must be a 'K' transaction A,C,S & D spoke for
02353                                                                   
...
02576                                                                   
02577      IF B1STPMTL GREATER THAN ZERO                                
02578          MOVE WS-CONVERTED-1ST-PMT-DT TO PB-I-1ST-PMT-DT          
02579      ELSE                                                         
02580          MOVE LOW-VALUES              TO PB-I-1ST-PMT-DT.         
02581                                                                   
...
02599                                                                   
02600      IF BLNTRML       GREATER THAN ZEROS                          
02601          MOVE BLNTRMI            TO PB-I-LOAN-TERM                
02602         ELSE                                                      
02603          MOVE ZEROS              TO PB-I-LOAN-TERM.               
02604                                                                   
02605      IF BFREQL        GREATER THAN ZEROS                          
02606          MOVE BFREQI             TO PB-I-PAY-FREQUENCY            
02607         ELSE                                                      
02608          MOVE ZEROS              TO PB-I-PAY-FREQUENCY.           
02609                                                                   
02610      IF BSKPCDL       GREATER THAN ZEROS                          
02611          MOVE BSKPCDI            TO PB-I-SKIP-CODE.               
02612                                                                   
02613      IF BMODEL        GREATER THAN ZEROS                          
02614          MOVE BMODEI             TO PB-I-TERM-TYPE                
02615                                     PI-BMODE.                     
02616                                                                   
02617      IF BPMTSL        GREATER THAN ZEROS                          
02618          MOVE BPMTSI             TO PB-I-NO-OF-PAYMENTS           
02619                                     PI-BPMTS                      
02620         ELSE                                                      
02621          MOVE ZEROS              TO PB-I-NO-OF-PAYMENTS           
02622                                     PI-BPMTS.                     
02623                                                                   
02624      IF BPMTAMTL      GREATER THAN ZEROS                          
02625          MOVE PI-BPMTAMT         TO PB-I-PAYMENT-AMOUNT           
02626         ELSE                                                      
...
02725      IF BAPRL > ZEROS
02726          MOVE WS-BAPR            TO PB-I-LOAN-APR                 
02727      ELSE
050713        if pi-company-id = 'CID'
050713           move +99.9999         to pb-i-loan-apr
050713        else
02728            MOVE ZEROS            TO PB-I-LOAN-APR
050713        end-if
050713     end-if
...
02745                                                                   
02746      IF BDAYSL   GREATER THAN ZEROS                               
02747         MOVE BDAYSI              TO PB-I-TERM-IN-DAYS             
02748                                     PB-I-EXTENTION-DAYS           
02749      ELSE                                                         
02750         MOVE ZEROS               TO PB-I-TERM-IN-DAYS             
02751                                     PB-I-EXTENTION-DAYS.          
02752                                                                   
02753      IF BDAYSL GREATER THAN ZEROS                                 
02754         MOVE '2'                 TO PB-I-DATA-ENTRY-SW.           
02755                                                                   
...
02763                                                                   
02764      IF B1STPMTL GREATER THAN ZEROS                               
02765         MOVE '4'                 TO PB-I-DATA-ENTRY-SW.           
02766                                                                   
...
02794                                                                   
02795      IF BLIVESL GREATER THAN ZEROS                                
02796         MOVE WS-BLIVES           TO PB-I-LIVES                    
02797      ELSE                                                         
02798         MOVE ZEROS               TO PB-I-LIVES.                   
02799                                                                   
02800      IF BBILLEDL GREATER THAN ZEROS                               
02801         MOVE WS-BILLED           TO PB-I-NUM-BILLED               
02802      ELSE                                                         
02803         MOVE ZEROS               TO PB-I-NUM-BILLED.              
02804                                                                   
011904*    MOVE WS-REFERENCE           TO PB-I-REFERENCE.               
02806                                                                   
...
02844      END-EXEC.                                                    
02845                                                                   
110921     move 'CERT'                 to pa-rec-type
...
02853                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD *> New Issue record
02855                                                                   
      ******************************************************************
...
02871                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD  *> Before BHDR Image
02873                                                                   
...
02883                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD  *> After BHDR Image
02885                                                                   
...
02891      MOVE LOW-VALUES             TO EL631BI.                      
...
03050 **********                                                        
012220     MOVE PB-ISSUE-RECORD TO WS-SAVE-PEND-ISSUE
03051                                                                   
...
03089                                                                   
041320*    PERFORM 8400-LOG-JOURNAL-RECORD. *> move closer to rewite
03091                                                                   
...
03123                                                                   
03124      IF B1STPMTL GREATER THAN ZERO                                
03125          MOVE WS-CONVERTED-1ST-PMT-DT TO PB-I-1ST-PMT-DT.         
03126                                                                   
...
03132
012220     IF LETRREQL   GREATER THAN ZEROS
012220        MOVE LETRREQI TO PB-I-LETTER-REQD
012220     END-IF.
012220
...
03138                                                                   
03139      IF BLNTRML  GREATER THAN ZEROS                               
03140          MOVE BLNTRMI            TO PB-I-LOAN-TERM.               
03141                                                                   
03142      IF BFREQL   GREATER THAN ZEROS                               
03143          MOVE BFREQI             TO PB-I-PAY-FREQUENCY.           
03144                                                                   
03145      IF BSKPCDL  GREATER THAN ZEROS                               
03146          MOVE BSKPCDI            TO PB-I-SKIP-CODE.               
03147                                                                   
03148      IF BMODEL   GREATER THAN ZEROS                               
03149          MOVE BMODEI             TO PB-I-TERM-TYPE                
03150                                     PI-BMODE.                     
03151                                                                   
03152      IF BPMTSL   GREATER THAN ZEROS                               
03153          MOVE BPMTSI             TO PB-I-NO-OF-PAYMENTS           
03154                                     PI-BPMTS.                     
03155                                                                   
03156      IF BPMTAMTL GREATER THAN ZEROS                               
03157          MOVE PI-BPMTAMT         TO PB-I-PAYMENT-AMOUNT.          
03158                                                                   
...
03210                                                                   
03211      IF BAPRL               GREATER THAN ZEROS                    
03212          MOVE WS-BAPR            TO PB-I-LOAN-APR.                
03213                                                                   
...
03225                                                                   
03226      IF BDAYSL              GREATER THAN ZEROS                    
03227         MOVE BDAYSI              TO PB-I-TERM-IN-DAYS             
03228                                     PB-I-EXTENTION-DAYS.          
03229                                                                   
03230      IF BDAYSL GREATER THAN ZEROS                                 
03231         MOVE '2'                 TO PB-I-DATA-ENTRY-SW.           
03232                                                                   
...
03240                                                                   
03241      IF B1STPMTL GREATER THAN ZEROS                               
03242         MOVE '4'                 TO PB-I-DATA-ENTRY-SW.           
03243                                                                   
...
03271                                                                   
03272      IF BLIVESL GREATER THAN ZEROS                                
03273         MOVE WS-BLIVES           TO PB-I-LIVES.                   
03274                                                                   
03275                                                                   
03276 *DMD CUSTOM CODING*************START                              
03277      IF PI-COMPANY-ID NOT = 'DMD'                                 
03278          MOVE ZEROS               TO BBILLEDL.                    
03279 *DMD CUSTOM CODING*************END                                
03280                                                                   
03281      IF BBILLEDL GREATER THAN ZEROS                               
03282         MOVE WS-BILLED           TO PB-I-NUM-BILLED.              
03283                                                                   
03284                                                                   
03285 ***************************************************************** 
...
03351                                                                   
012220     IF CSR-EDIT-SESSION
012220        PERFORM 139A-SET-LETTER-REQD THRU 139A-EXIT
012220     END-IF.
012220
03352      PERFORM 1390-UPDATE-ERPNDM THRU 1399-EXIT.
03353                                                                   
03354      PERFORM 9800-LINK-PENDING-EDIT THRU 9800-EXIT.               
03355                                                                   
03356      PERFORM 7300-FORMAT-ERRORS  THRU 7399-EXIT.                  
012220
012220     IF ARCHIVE-LETTER-RELEASED
012220        MOVE 'C' TO PB-I-LETTER-REQD
012220        PERFORM 9800-LINK-PENDING-EDIT THRU 9800-EXIT
012220        PERFORM 7300-FORMAT-ERRORS  THRU 7399-EXIT
012220     END-IF
03357                                                                   
...
121712     EXIT.                                                        
121712
03434  1390-UPDATE-ERPNDM.                                              
03435                                                                   
03436      EXEC CICS HANDLE CONDITION                                   
03437          NOTFND (1399-EXIT)                                       
03438      END-EXEC.                                                    
03439                                                                   
...
03476  1399-EXIT.                                                       
03477      EXIT.
012220 139A-SET-LETTER-REQD.
012220*  COMPARE BEFORE AND AFTER CHANGE
012220     IF PB-ISSUE-RECORD = WS-SAVE-PEND-ISSUE
012220        GO TO 139A-EXIT
012220     END-IF
012220
012220*  READ ELCRTO
012220     MOVE PB-CONTROL-BY-ACCOUNT (1:33)
012220                                 TO ELCRTO-KEY
012220     MOVE 'I'                    TO ELCRTO-RECORD-TYPE
012220     MOVE +0                     TO ELCRTO-SEQ-NO
012220
012220     EXEC CICS READ
012220        DATASET   ('ELCRTO')
012220        INTO      (ORIGINAL-CERTIFICATE)
012220        RIDFLD    (ELCRTO-KEY)
012220        GTEQ
012220        RESP      (WS-RESPONSE)
012220     END-EXEC
012220
012220*    display ' just read gteq ' ws-response
012220     IF RESP-NORMAL
012220        AND (OC-CONTROL-PRIMARY (1:33) =
012220                 PB-CONTROL-BY-ACCOUNT (1:33))
012220        AND (OC-RECORD-TYPE = 'I')
012220*      compare individual fields
012220        IF LETRREQL   GREATER THAN ZEROS
012220           CONTINUE
012220        ELSE
012220        IF OC-CERT-NO = PB-CERT-NO
012220          AND OC-CERT-EFF-DT = PB-CERT-EFF-DT
012220          AND OC-INS-LAST-NAME = PB-I-INSURED-LAST-NAME
012220          AND OC-INS-FIRST-NAME = PB-I-INSURED-FIRST-NAME
012220          AND OC-INS-MIDDLE-INIT =  PB-I-INSURED-MIDDLE-INIT
012220          AND OC-INS-AGE = PB-I-AGE
012220          AND OC-LF-BENCD = PB-I-LIFE-BENEFIT-CD
012220          AND OC-LF-TERM = PB-I-LF-TERM
012220          AND OC-LF-BEN-AMT = PB-I-LF-BENEFIT-AMT
012220          AND OC-LF-PRM-AMT = PB-I-LF-PREMIUM-AMT
012220          AND OC-LF-EXP-DT = PB-I-LF-EXPIRE-DT
012220          AND OC-LF-ALT-BEN-AMT = PB-I-LF-ALT-BENEFIT-AMT
012220          AND PB-I-LF-ALT-PREMIUM-AMT = OC-LF-ALT-PRM-AMT
012220          AND PB-I-LF-EXPIRE-DT = OC-LF-EXP-DT
012220          AND PB-I-AH-BENEFIT-CD     = OC-AH-BENCD
012220          AND PB-I-AH-TERM           = OC-AH-TERM
012220          AND PB-I-AH-BENEFIT-AMT    = OC-AH-BEN-AMT
012220          AND PB-I-AH-PREMIUM-AMT    = OC-AH-PRM-AMT
012220          AND PB-I-AH-EXPIRE-DT      = OC-AH-EXP-DT
012220          AND PB-I-AH-COMMISSION     = OC-AH-COMM-PCT
012220          AND PB-I-AH-CRIT-PER       = OC-AH-CP
012220           MOVE SPACE TO PB-I-LETTER-REQD
012220        ELSE
012220           MOVE 'Y' TO PB-I-LETTER-REQD
012220        END-IF
012220     END-IF.
012220
012220 139A-EXIT.
...
072120******************************************************************
072120*                                                                *
072120*       Determine if this is a dup and we should allow the       *
072120*       user to delete the pending issue record only.            *
072120*                                                                *
072120******************************************************************

072120     MOVE PB-CONTROL-BY-ACCOUNT (1:33)
072120                                 TO ELCERT-KEY
072120     EXEC CICS READ
072120         SET     (ADDRESS OF CERTIFICATE-MASTER)
072120         DATASET (FILE-ID-ELCERT)
072120         RIDFLD  (ELCERT-KEY)
072120         RESP    (WS-RESPONSE)
072120     END-EXEC

072120     if (resp-normal)
072120        and (cert-added-batch)
072120        and (valid-cm-id)
072120        go to 1420-CONTINUE-DELETE
072120     end-if

022017******************************************************************
022017*                                                                *
022017*       Determine if there have been any checks created          *
022017*                                                                *
022017******************************************************************
022017
022017     perform 2500-browse-checks  thru 2500-exit
022017
022017     if i-have-processed-checks
022017        or i-have-checks
022017        or i-have-a-check-period
022017        move er-3446             to emi-error
022017        perform 9900-error-format thru 9900-exit
022017        move al-uabon            to bmainta
022017        move -1                  to bmaintl
022017        go to 8200-send-dataonly
022017     end-if
...
041320*        EQUAL                                                    
041320*        DATASET   (FILE-ID-ERNOTE)                               
041320*        SET       (ADDRESS OF CERTIFICATE-NOTE)                  
041320*        RIDFLD    (ELCERT-KEY)                                   
041320*        UPDATE                                                   
041320*    END-EXEC.                                                    
03695                                                                   
...
041320        PERFORM 8400-LOG-JOURNAL-RECORD  *> Before Image
...
03816         END-EXEC                                                  
041320        PERFORM 8400-LOG-JOURNAL-RECORD  *> After Image
           end-if
...
03865      MOVE LOW-VALUES             TO EL631BI.                      
...
04479                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD  *> Journal Cancel Add
04481                                                                   
071712******************************************************************
...
04517      MOVE LOW-VALUES             TO EL631CI.                      
...
04716                                                                   
041320*    PERFORM 8400-LOG-JOURNAL-RECORD  *>Move closer to rewrite
04718                                                                   
...
05088                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD  *> Journal Cancel Delete
05090                                                                   
...
05114         END-EXEC                                                  
041320        PERFORM 8400-LOG-JOURNAL-RECORD  *> Journal BHDR Delete
05116      ELSE                                                         
...
05175      MOVE LOW-VALUES             TO EL631CI.                      
...
111513              set i-say-stop to true
111513        else
022017           set i-have-a-check-period to true
...
05235                                                                   
041320     PERFORM 8400-LOG-JOURNAL-RECORD  *> Journal Add
...
052020     move pi-prev-control-primary to pa-current-key
052020     move erpndb-alt-key          to pa-new-alt-key
052020     move spaces                  to pa-return-area
052020
052020     EXEC CICS LINK
052020        PROGRAM   ('EL055')
052020        COMMAREA  (EL055-PASS-AREA)
052020        LENGTH    (256)
052020     END-EXEC

052020     if ra-status-code = +99  *> found a claim
052020        move -1                  to bmaintl
052020        move al-uabon            to bmainta
052020        move er-2878             to emi-error
052020        perform 9900-error-format thru 9900-exit
052020        go to 8200-send-dataonly
052020     end-if
052020
052020     if ra-status-code = +88  *> found dup cert
052020        move -1                  to bmaintl
052020        move al-uabon            to bmainta
052020        move er-0229             to emi-error
052020        perform 9900-error-format thru 9900-exit
052020        go to 8200-send-dataonly
052020     end-if

           GO TO 1325-PROCESS-ISSUE-CHANGES
...
06290      MOVE LOW-VALUES             TO EL631BI.                      
06291                                                                   
06292      IF PI-MAP-NAME = EL631B                                      
...
06511 *         THE INITIAL ENTRY OF EL6311, RETURN TO THE CALLING      
06512 *         PROGRAM.                                               *
06513 *                                                                *
06514 ******************************************************************
06515                                                                   
...
06538         MOVE EL631D               TO PI-MAP-NAME                  
06539         GO TO 8100-SEND-INITIAL-MAP.                              
06540                                                                   
06541      IF PI-MAP-NAME = EL631B                                      
06542         MOVE -1                  TO BMAINTL                       
06543      ELSE                                                         
06544         IF PI-MAP-NAME = EL631C                                   
...
06803 *         THE INITIAL ENTRY OF EL6311, RETURN TO THE CALLING     *
06804 *         PROGRAM.                                               *
06805 *                                                                *
06806 ******************************************************************
06807                                                                   
...
06824         MOVE EL631B              TO PI-MAP-NAME                   
06825         GO TO 8100-SEND-INITIAL-MAP.                              
06826                                                                   
06827      IF PI-MAP-NAME = EL631B                                      
06828         MOVE -1                  TO BMAINTL                       
06829      ELSE                                                         
06830         IF PI-MAP-NAME = EL631C                                   
...
07034 *         THE INITIAL ENTRY OF EL6311, RETURN TO THE CALLING      
07035 *         PROGRAM.                                               *
07036 *                                                                *
07037 ******************************************************************
07038                                                                   
...
07061         MOVE EL631D               TO PI-MAP-NAME                  
07062         GO TO 8100-SEND-INITIAL-MAP.                              
07063                                                                   
07064      IF PI-MAP-NAME = EL631B                                      
07065         MOVE -1                  TO BMAINTL                       
07066      ELSE                                                         
07067         IF PI-MAP-NAME = EL631C                                   
...
07298 *         THE INITIAL ENTRY OF EL6311, RETURN TO THE CALLING    * 
07299 *         PROGRAM.                                               *
07300 *                                                                *
07301 ******************************************************************
07302                                                                   
...
07319         MOVE EL631B               TO PI-MAP-NAME                  
07320         GO TO 8100-SEND-INITIAL-MAP.                              
07321                                                                   
07322      IF PI-MAP-NAME = EL631B                                      
07323         MOVE -1                  TO BMAINTL                       
07324      ELSE                                                         
07325         IF PI-MAP-NAME = EL631C                                   
...
07504      IF PI-MAP-NAME = EL631B                                      
07505         MOVE -1                  TO BMAINTL                       
07506      ELSE                                                         
07507         IF PI-MAP-NAME = EL631C                                   
...
07570         ELSE                                                      
07571            IF PI-MAP-NAME NOT = EL631D                            
...
07738      IF PI-MAP-NAME = EL631B                                      
07739         MOVE -1                  TO BMAINTL                       
07740      ELSE                                                         
07741         IF PI-MAP-NAME = EL631C                                   
...
08142      IF PI-MAP-NAME = EL631B                                      
08143         MOVE -1                  TO BMAINTL                       
08144      ELSE                                                         
08145         IF PI-MAP-NAME = EL631C                                   
...
08316 *         THE INITIAL ENTRY OF EL6311, RETURN TO THE CALLING     *
08317 *         PROGRAM.                                               *
08318 *                                                                *
08319 ******************************************************************
08320                                                                   
...
08332         MOVE EL631D              TO PI-MAP-NAME                   
08333         MOVE -1                  TO DPFENTRL                      
08334         GO TO 8100-SEND-INITIAL-MAP.                              
08335                                                                   
08336      IF PI-MAP-NAME = EL631B                                      
08337         MOVE -1                  TO BMAINTL                       
08338      ELSE                                                         
08339         IF PI-MAP-NAME = EL631C                                   
...
020218     EXEC CICS GETMAIN
020218         SET     (ADDRESS OF CERTIFICATE-TRAILERS)
020218         LENGTH  (ELCRTT-RECORD-LENGTH)
020218         INITIMG (GETMAIN-SPACE)                                 
020218     END-EXEC
020218
020218     move ' '                    to ws-elcrtt-update-sw
020218     MOVE PI-PREV-ALT-KEY (1:33) TO ELCRTT-PRIMARY
020218     MOVE 'C'                    TO ELCRTT-REC-TYPE
020218
020218     EXEC CICS READ
020218         UPDATE
020218         DATASET  (CRTT-ID)
020218         RIDFLD   (ELCRTT-KEY)
020218         INTO     (CERTIFICATE-TRAILERS)
020218         resp     (ws-response)
020218     END-EXEC
020218
020218     if resp-normal
020218        if cs-claim-verification-status = 'B' or 'C' or 'D' or
020218                  'E' or 'F' or 'G'
020218           move 'J'              to cs-claim-verification-status
...
08546                                                                   
08547      IF PI-BMODE = ' ' OR 'M'                                     
08548          MOVE PI-BPMTS      TO WS-CALC-TERM-WHOLE                 
08549          GO TO 6105-ROUND-TERM.                                   
08550                                                                   
08551      IF PI-BMODE = 'S'                                            
08552          COMPUTE WS-CALC-TERM = PI-BPMTS / 2                      
08553          GO TO 6105-ROUND-TERM.                                   
08554                                                                   
08555      IF PI-BMODE = 'W'                                            
08556          COMPUTE WS-CALC-TERM = PI-BPMTS / 4.33333                
08557          GO TO 6105-ROUND-TERM.                                   
08558                                                                   
08559      IF PI-BMODE = 'B'                                            
08560          COMPUTE WS-CALC-TERM = PI-BPMTS / 2.16667                
08561          GO TO 6105-ROUND-TERM.                                   
08562                                                                   
08563      IF PI-BMODE = 'T'                                            
08564          COMPUTE WS-CALC-TERM = PI-BPMTS / 1.08334.               
08565                                                                   
...
08579                                                                   
08580      IF BTERM-LEN (WS-SUB1) GREATER THAN +0                       
08581          IF WS-BTERM (WS-SUB1)   NOT = WS-CALC-TERM-WHOLE         
08582              MOVE -1               TO BMODEL                      
08583              MOVE ER-2593          TO EMI-ERROR                   
08584              MOVE AL-UNBON         TO BTERM-ATTRB (WS-SUB1)       
08585              PERFORM 9900-ERROR-FORMAT THRU 9900-EXIT.            
08586                                                                   
...
08609                                                                   
08610      IF PI-BMODE = 'M' OR  ' '                                    
08611          MOVE PI-BPMTAMT        TO  WS-BBEN (WS-SUB1).            
08612                                                                   
08613      IF PI-BMODE = 'W'                                            
08614          COMPUTE WS-BBEN (WS-SUB1) ROUNDED = PI-BPMTAMT * 4.33333.
08615                                                                   
08616      IF PI-BMODE = 'S'                                            
08617          COMPUTE WS-BBEN (WS-SUB1)  ROUNDED = PI-BPMTAMT * 2.     
08618                                                                   
08619      IF PI-BMODE = 'B'                                            
08620          COMPUTE WS-BBEN (WS-SUB1) ROUNDED = PI-BPMTAMT * 2.16667.
08621                                                                   
08622      IF PI-BMODE = 'T'                                            
08623          COMPUTE WS-BBEN (WS-SUB1) ROUNDED = PI-BPMTAMT * 1.08334.
08624                                                                   
08625      IF WS-SUB1 = +1                                              
...
08655                                                                   
08656      MOVE LOW-VALUES                 TO EL631BI.                  
08657      MOVE ZEROS                      TO PI-BPMTAMT                
08658                                         PI-BPMTS.                 
08659      MOVE SPACE                      TO PI-BMODE                  
08660                                         PI-BTYPE (1)              
08661                                         PI-BTYPE (2).             
08662      MOVE EL631B                     TO PI-MAP-NAME.              
...
012220     MOVE PB-I-LETTER-REQD           TO LETRREQO
012220
08709                                                                   
...
08731                                                                   
08732      IF PB-I-1ST-PMT-DT NOT = LOW-VALUES                          
08733          MOVE PB-I-1ST-PMT-DT        TO DC-BIN-DATE-1             
08734          MOVE SPACE                  TO DC-OPTION-CODE            
08735          PERFORM 9700-DATE-LINK                                   
08736          IF NO-CONVERSION-ERROR                                   
08737             MOVE DC-GREG-DATE-1-EDIT TO B1STPMTO.                 
08738                                                                   
08739      IF PB-I-EXTENTION-DAYS NUMERIC                               
08740         IF PB-I-EXTENTION-DAYS GREATER THAN ZEROS                 
08741            MOVE PB-I-EXTENTION-DAYS  TO BDAYSO                    
08742         ELSE                                                      
08743            IF PB-I-TERM-IN-DAYS NUMERIC                           
08744               IF PB-I-TERM-IN-DAYS GREATER THAN ZEROS             
08745                  MOVE PB-I-TERM-IN-DAYS TO BDAYSO.                
08746                                                                   
08747      IF PB-I-LOAN-TERM GREATER THAN ZEROS                         
08748         MOVE PB-I-LOAN-TERM          TO BLNTRMO.                  
08749                                                                   
08750      MOVE PB-FORCE-CODE              TO BFORCEO.                  
08751      MOVE PB-I-TERM-TYPE             TO BMODEO                    
08752                                         PI-BMODE.                 
08753                                                                   
08754      IF PB-I-PAY-FREQUENCY GREATER THAN ZEROS                     
08755         MOVE PB-I-PAY-FREQUENCY      TO BFREQO.                   
08756                                                                   
08757      IF PB-I-NO-OF-PAYMENTS GREATER THAN ZEROS                    
08758          MOVE PB-I-NO-OF-PAYMENTS    TO BPMTSO                    
08759                                         PI-BPMTS.                 
08760                                                                   
08761      IF PB-I-PAYMENT-AMOUNT NUMERIC                               
08762          IF PB-I-PAYMENT-AMOUNT GREATER THAN ZEROS                
08763            MOVE PB-I-PAYMENT-AMOUNT  TO BPMTAMTO                  
08764                                         PI-BPMTAMT.               
08765                                                                   
...
08776                                                                   
08777      IF (PB-I-LIVES NUMERIC)
08778         AND (PB-I-LIVES > ZEROS)
              PERFORM 6210-READ-ERACCT THRU 6210-EXIT
              IF (RESP-NORMAL)
                 AND (AM-DCC-PRODUCT-CODE = 'DDF')
                 CONTINUE
              ELSE
08779            MOVE PB-I-LIVES       TO BLIVESO
              END-IF
           END-IF
08782                                                                   
08783      IF PB-I-NUM-BILLED NUMERIC AND                               
08784         PB-I-NUM-BILLED GREATER THAN ZEROS                        
08785         MOVE PB-I-NUM-BILLED         TO BBILLEDO.                 
08786 *    ELSE                                                         
08787 *       MOVE ZEROS                   TO BBILLEDO.                 
08788                                                                   
08789      MOVE PB-CHG-COUNT               TO BCHGCNTO.                 
08790                                                                   
111913     IF PB-I-LOAN-APR NOT = +99.9999
08792         MOVE PB-I-LOAN-APR           TO BAPRO.                    
08793                                                                   
08794      IF PB-I-MEMBER-NO  GREATER THAN SPACES                       
08795         MOVE PB-I-MEMBER-NO          TO BMEMBERO.                 
08796                                                                   
08797      IF PB-ORIGINAL-ENTRY-BATCH NOT = SPACES                      
08798         IF PB-ORIGINAL-ENTRY-BATCH NOT = PB-ENTRY-BATCH           
08799            MOVE AL-SANOF                TO BORIGHDA               
08800            MOVE PB-ORIGINAL-ENTRY-BATCH TO BORGNOO                
08801            MOVE PB-ORIGINAL-SEQ-NO      TO BORGSEQO.              
08802                                                                   
...
072312
012220     IF ARCHIVE-LETTER-RELEASED
012220        PERFORM 7050-UPDATE-PENDING THRU 7050-EXIT
012220     END-IF
...
08938      EJECT                                                        
012220
012220 7050-UPDATE-PENDING.
012220     EXEC CICS READ
012220         DATASET (FILE-ID-ERPNDB)
012220         INTO    (PENDING-BUSINESS)
012220         RIDFLD  (PI-PREV-CONTROL-PRIMARY)
012220         UPDATE
012220     END-EXEC.
012220
012220     MOVE 'C' TO PB-I-LETTER-REQD
012220     MOVE PB-I-LETTER-REQD       TO LETRREQO
012220     MOVE PI-PROCESSOR-ID        TO PB-LAST-MAINT-BY.
012220     MOVE EIBTIME                TO PB-LAST-MAINT-HHMMSS.
012220     MOVE EIBDATE                TO DC-JULIAN-YYDDD.
012220     MOVE '5'                    TO DC-OPTION-CODE.
012220     PERFORM 9700-DATE-LINK
012220     MOVE DC-BIN-DATE-1          TO PB-LAST-MAINT-DT.
012220
012220     EXEC CICS REWRITE
012220         DATASET (FILE-ID-ERPNDB)
012220         FROM    (PENDING-BUSINESS)
012220     END-EXEC.
012220
012220 7050-EXIT.
012220      EXIT.
...
08957                                                                   
08958      MOVE LOW-VALUES                 TO EL631CI.                  
08959      MOVE EL631C                     TO PI-MAP-NAME.              
...
052918     MOVE 'N'                    TO ACTSPCO
052918     MOVE PB-CONTROL-BY-ACCOUNT  TO ERACNT-KEY
052918     MOVE '2'                    TO ERACNT-REC-TYPE
052918     MOVE +3                     TO ERACNT-SEQ-NO
052918
052918     EXEC CICS READ
052918          DATASET   ('ERACNT')
052918          INTO      (NOTE-FILE)
052918          RIDFLD    (ERACNT-KEY)
052918          RESP      (WS-RESPONSE)
052918     END-EXEC
052918
052918     IF RESP-NORMAL
052918        IF NT-account-special = 'Y'
052918           MOVE 'Y'              TO actspcO
052918           MOVE ER-1762          TO EMI-ERROR
...
09222      MOVE EL631D                 TO PI-MAP-NAME.                  
09223      MOVE LOW-VALUES             TO EL631DI.                      
09224                                                                   
...
09250                                                                   
09251      MOVE EL631D                 TO PI-MAP-NAME.                  
09252      MOVE LOW-VALUES             TO EL631DI.                      
...
020218     move +0                     to pi-6311-fatal-ctr
...
020218     if (emi-fatal)
020218        and (emi-error not = 1753 and 1754 and 1757 and
020218                             1758 and 1759 and 1760)
020218        add +1                   to pi-6311-fatal-ctr
020218     end-if
...
012220            IF CALLED-FROM-6315
012220               MOVE 'Y' TO WS-ARCHIVE-LETTER-SW
012220            END-IF
...
012220
012220     IF PB-COMMON-ERROR    (WS-SUB4) = ER-1577
012220        MOVE -1                  TO LETRREQL
012220        MOVE AL-UABOF            TO LETRREQA
012220        MOVE  1                  TO SET-CURSOR-SW
012220        GO TO 7499-EXIT.
012220
012220     IF PB-COMMON-ERROR    (WS-SUB4) = ER-1584
012220        MOVE AL-UABOF            TO LETRREQA
012220        GO TO 7499-EXIT.
09602                                                                   
09603 **2626**                                                          
...
09710 **2648**                                                          
09711                                                                   
020711     IF PB-COMMON-ERROR (WS-SUB4) = ER-2648 OR ER-1575
012820              or er-3070
09713         MOVE AL-UNBON            TO BLNTRMA                       
09714         MOVE -1                  TO BLNTRML                       
09715         MOVE  1                  TO SET-CURSOR-SW                 
09716         GO TO 7499-EXIT.                                          
09717                                                                   
09718 **2649**                                                          
09719                                                                   
...
09757 **2651**                                                          
09758                                                                   
09759      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2651
...
09765 **2653**                                                          
09766                                                                   
09767      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2653                    
09768         MOVE AL-UABON            TO BFREQA                        
09769         MOVE -1                  TO BFREQL                        
09770         MOVE  1                  TO SET-CURSOR-SW                 
09771         GO TO 7499-EXIT.                                          
09772                                                                   
09773 **2654**                                                          
09774                                                                   
09775      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2654                    
09776         MOVE AL-UABON            TO BFREQA                        
09777         MOVE -1                  TO BFREQL                        
09778         MOVE  1                  TO SET-CURSOR-SW                 
09779         GO TO 7499-EXIT.                                          
09780                                                                   
09781 **2655**                                                          
09782                                                                   
09783      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2655                    
09784         MOVE AL-UABON            TO BFREQA                        
09785         MOVE -1                  TO BFREQL                        
09786         MOVE  1                  TO SET-CURSOR-SW                 
09787         GO TO 7499-EXIT.                                          
09788                                                                   
09789 **2656**                                                          
09790                                                                   
09791      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2656                    
09792         MOVE AL-UNBON            TO BAPRA                         
09793         MOVE -1                  TO BAPRL                         
09794         MOVE  1                  TO SET-CURSOR-SW                 
09795         GO TO 7499-EXIT.                                          
09796                                                                   
09797 **2657**                                                          
09798                                                                   
09799      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2657                    
09800         MOVE AL-UNBON            TO BAPRA                         
09801         MOVE -1                  TO BAPRL                         
09802         MOVE  1                  TO SET-CURSOR-SW                 
09803         GO TO 7499-EXIT.                                          
09804                                                                   
09805 **2658**                                                          
09806                                                                   
...
09926 **2680**                                                          
09927                                                                   
09928      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2680                    
09929         MOVE AL-UABOF            TO B1STPMTA                      
09930         MOVE -1                  TO B1STPMTL                      
09931         MOVE  1                  TO SET-CURSOR-SW                 
09932         GO TO 7499-EXIT.                                          
09933                                                                   
09934 **2681**                                                          
09935                                                                   
09936      IF PB-COMMON-ERROR    (WS-SUB4) = ER-2681                    
09937         MOVE AL-UABON            TO BDAYSA                        
09938         MOVE -1                  TO BDAYSL                        
09939         MOVE  1                  TO SET-CURSOR-SW                 
09940         GO TO 7499-EXIT.                                          
09941                                                                   
09942 **2682**                                                          
09943                                                                   
...
10314           IF PI-MAP-NAME = EL631B                                 
10315              MOVE AL-SADOF               TO BPF5HDRA              
10316                                             BPF4HDRA              
10317           ELSE                                                    
10318              IF PI-MAP-NAME = EL631C                              
10319                 MOVE AL-SADOF            TO CPF5HDRA              
10320                                             CPF4HDRA.             
10321                                                                   
090612     IF PI-MAP-NAME = EL631B                                 
090612        MOVE AL-SADOF               TO BPF5HDRA
090612     ELSE
090612        MOVE AL-SADOF               TO CPF5HDRA
090612     END-IF
10322                                                                   
10323 *DMD CUSTOM CODING*************START    DO IT WHEN SCREEN=EL631B &
10324      IF PI-MAP-NAME = EL631B                                      
10325           IF PI-COMPANY-ID NOT = 'DMD'                            
10326              MOVE AL-SANOF            TO BBILLEDA                 
10327              MOVE AL-SADOF            TO DMDBILA.                 
10328 *DMD CUSTOM CODING*************END                                
10329                                                                   
10330      IF PI-PROCESSOR-ID = 'LGXX'                                  
10331         IF PI-MAP-NAME = EL631B                                   
10332            MOVE AL-SABOF                    TO BREFHDGA           
10333            MOVE AL-SANOF                    TO BREFA              
10334         ELSE                                                      
10335            IF PI-MAP-NAME = EL631C                                
...
10341         continue
10342      ELSE
10343         IF PI-MAP-NAME = EL631C
10344            MOVE AL-SADOF         TO CCANTXTA                   
10345                                     CCANFEEA
              end-if
           end-if

10347      IF PI-MAP-NAME = EL631D                                      
...
081606        AND (PI-MAP-NAME = EL631B)
081606        MOVE AL-SADOF            TO BVINHA
081606                                    BVINA
081606     END-IF

10353      IF PI-MAP-NAME = EL631B                                      
...
10411            ELSE                                                   
10412                MOVE EL631D             TO PI-MAP-NAME             
...
10452                                                                   
10453 *DMD CUSTOM CODING*************START    DO IT WHEN SCREEN=EL631B &
10454         IF PI-COMPANY-ID NOT = 'DMD'                              
10455              MOVE AL-SANOF            TO BBILLEDA                 
10456              MOVE AL-SADOF            TO DMDBILA                  
10457          ELSE                                                     
10458             NEXT SENTENCE                                         
10459 *DMD CUSTOM CODING*************END                                
10460      ELSE                                                         
10461         IF PI-MAP-NAME = EL631C                                   
...
041320        if csr-edit-session
041320           move 'EL6311C'        to jp-program-id
041320        else
...
041320           continue
041320        else
041320           display ' error-el6311-journal ' ws-response
041320        end-if
041320     end-if
041320
041320*    EXEC CICS JOURNAL                                            
...
10531                                                                   
10532      IF  PI-MAP-NAME =  EL631B                                    
10533          MOVE '631B'             TO PI-CURRENT-SCREEN-NO.         
10534                                                                   
10535      IF  PI-MAP-NAME =  EL631C                                    
10536          MOVE '631C'             TO PI-CURRENT-SCREEN-NO.         
10537                                                                   
10538      IF  PI-MAP-NAME =  EL631D                                    

...
000016***                                                            ***
000017***  Post check number and check written date to refund checks ***
000018***                                                            ***
000019***_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-***
000020
000021******************************************************************
...
000028*-----------------------------------------------------------------
000029* 011714  CR2013053000001  PEMA  NEW PROGRAM
000030* 022014  IR2014022000001  PEMA  chg process when file is empty
000031* 082014  IR2014081400001  PEMA  bypass manual request checks
000032* 082014  IR2015082100001  PEMA  bypass more manual request checks
000033* 092215  IR2015092200001  PEMA  modify determination of manual ch
000034* 091615  CR2015082000001  PEMA  Add Endorsement check processing
000035* 020816  IR2016020500001  PEMA  Add env to unikix cmd for cid1p
000036* 042517  IR2017042500001  PEMA  Reduce number of print lines per
000037* 060717  CR2017032900002  PEMA  CHANGE TEST DB
000038* 030921  CR2019012500003  PEMA  Connect to sdv-db01.cso.local
000039* 062121  CR2021021600001  PEMA  ADD PROCESSING FOR NEW COMP FNL
000040* 032422  IR2022031600001  PEMA  Bypass previously processed recor
000041
000042 environment division.
000043 INPUT-OUTPUT SECTION.
000044 FILE-CONTROL.
000045
000046 SELECT CPS-WRITTEN-IN ASSIGN TO dynamic ws-written-in
000047    FILE STATUS IS WRITTEN-STATUS
000048                            ORGANIZATION IS LINE SEQUENTIAL.
000049
000050 SELECT CPS-WRITTEN-RPT ASSIGN TO dynamic ws-written-rpt
000051    FILE STATUS IS WRITRPT-STATUS
000052                            ORGANIZATION IS LINE SEQUENTIAL.
000053
000054 data division.
000055 FILE SECTION.
000056
000057 FD  CPS-WRITTEN-IN
000058     BLOCK CONTAINS 0
000059     RECORDING MODE F.
000060 01  CPS-WRITTEN-IN-REC          pic x(200).
000061
000062 FD  CPS-WRITTEN-RPT
000063     BLOCK CONTAINS 0
000064     RECORDING MODE F.
000065 01  CPS-WRITTEN-RPT-REC         pic x(132).
000066
...
000688
000689     move function upper-case(ws-comp-id)
000690                                 to ws-work-comp-id
000691     evaluate true
000692        when ws-work-comp-id = 'AHL'
000693           move 'miscpymtsahl.csv'
000694                                 to ws-work-file-in
000695           move 'ahlg201b'       to ws-work-job-name
000696        when ws-work-comp-id = 'FNL'
000697           move 'miscpymtsfnl.csv'
000698                                 to ws-work-file-in
000699           move 'fllg201b'       to ws-work-job-name
000700        when other
000701           move 'miscpymts.csv'  to ws-work-file-in
000702           move 'cilg201b'       to ws-work-job-name
000703     end-evaluate
000704
000705     move spaces                 to ws-written-in
000706                                    ws-written-rpt
000707
000708     string
000709        ws-work-dir delimited by space
000710        ws-work-file-in delimited by space
000711           into ws-written-in
000712     end-string
000713     move 'miscpymts.rpt'        to ws-work-rpt-out
000714     string
000715        ws-work-dir delimited by space
000716        ws-work-comp-id delimited by size
000717        ws-work-rpt-out delimited by size
000718           into ws-written-rpt
000719     end-string
000720     string
000721        'unikixjob '     delimited by size
000722        ws-work-job-name delimited by size
000723        ' -k '           delimited by size
000724        ws-work-env      delimited by space
000725           into tran-data-line2
000726     end-string
000727
000728*     display ' svr    ' svr
000729*     display ' user   ' usr
000730*     display ' pw     ' pass
000731*     display ' input  ' ws-written-in
000732*     display ' output ' ws-written-rpt
000733*     display '        '
000734*     display ' line 1 ' tran-data-line1
000735*     display ' line 2 ' tran-data-line2
000736
000737     open input CPS-WRITTEN-IN
000738         output CPS-WRITTEN-RPT
000739
000740     if written-status not = '00'
000741        display 'error written open ' written-status
000742        move ' Invalid or missing file '
000743                                 to output-msg
000744        go to 0000-return
000745     end-if
000746
000747     .
000748 2010-exit.
...
000751 2020-init.
000752
000753     move spaces                 to ws-detail1
000754     move ws-hd1-written         to ws-head1
000755     move 'EL201B'               to ws-h1-rpt-id
000756     move ws-hd4-written         to ws-heading4
000757     move 'Posting of Written Checks '
000758                                 to output-title
000759*    if ws-comp-id = 'AHL'
000760*       move 'ahlg201b'          to tdl2-job
000761*    else
000762*       move 'cilg201b'          to tdl2-job
000763*    end-if
000764
000765     if not connected-to-db
000766        perform 1000-connect-db  thru 1000-exit
000767     end-if
000768
000769***-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_***
000770***                                                            ***
000771**     I do 2 reads to bypass the header record                ***
000772***                                                            ***
000773***_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-***
000774
000775     perform 2040-read-input     thru 2040-exit
000776     perform 2040-read-input     thru 2040-exit
000777
000778     .
000779 2020-exit.
000780     exit.
000781
000782 2040-read-input.
000783
000784     read CPS-WRITTEN-IN at end
000785        set end-of-input   to true
000786     end-read
000787
000788     if not end-of-input
000789        add 1 to ws-in-recs
000790     end-if
000791
000792     .
000793 2040-exit.
000794     exit.
000795
000796 2050-process-input.
000797
000798     move spaces                 to ws-raw-record
000799                                    ws-written-rec
000800                                    ws-bypass-ind
000801
000802     unstring cps-written-in-rec
000803        delimited by ',' into
000804           raw-check-no
000805           raw-check-dt
000806           raw-check-amt
000807           raw-vendor-id
000808           raw-user-defined
000809           raw-voucher-ref
000810     end-unstring
000811
000812*    display ' chk no    **' wsw-check-no '**'
000813*    display ' chk dt    **' wsw-check-dt '**'
000814*    display ' chk amt   **' wsw-check-amt '**'
000815*    display ' vend id   **' wsw-vendor-id '**'
000816*    display ' user def  **' wsw-user-defined '**'
000817*    display ' vouch ref **' wsw-voucher-ref '**'
000818
000819***-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_***
000820***                                                            ***
000821***    Every now and then I get bogus records with quotes      ***
000822***  so I am just going to remove them.  These are normally    ***
000823***  a result of a manual process that should not be included  ***
000824***  in this file.                                             ***
000825***                                                            ***
000826***_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-***
000827
000828     move +1                     to o1
000829     perform varying i1 from +1 by +1 until i1 > +20
000830        if raw-check-no (i1:1) <> '"'
000831           move raw-check-no (i1:1)
000832                                 to wsw-check-no (o1:1)
000833           add +1 to o1
000834        end-if
000835     end-perform
000836
000837     move +1                     to o1
000838     perform varying i1 from +1 by +1 until i1 > +20
000839        if raw-check-dt (i1:1) <> '"'
000840           move raw-check-dt (i1:1)
000841                                 to wsw-check-dt (o1:1)
000842           add +1 to o1
000843        end-if
000844     end-perform
000845
000846     move +1                     to o1
000847     perform varying i1 from +1 by +1 until i1 > +15
000848        if raw-check-amt (i1:1) <> '"'
000849           move raw-check-amt (i1:1)
000850                                 to wsw-check-amt (o1:1)
000851           add +1 to o1
000852        end-if
000853     end-perform
000854
000855     move +1                     to o1
000856     perform varying i1 from +1 by +1 until i1 > +20
000857        if raw-vendor-id (i1:1) <> '"'
000858           move raw-vendor-id (i1:1)
000859                                 to wsw-vendor-id (o1:1)
000860           add +1 to o1
000861        end-if
000862     end-perform
000863
000864     move +1                     to o1
000865     perform varying i1 from +1 by +1 until i1 > +30
000866        if raw-user-defined (i1:1) <> '"'
000867           move raw-user-defined (i1:1)
000868                                 to wsw-user-defined (o1:1)
000869           add +1 to o1
000870        end-if
000871     end-perform
000872
000873     move +1                     to o1
000874     perform varying i1 from +1 by +1 until i1 > +35
000875        if raw-voucher-ref (i1:1) <> '"'
000876           move raw-voucher-ref (i1:1)
000877                                 to wsw-voucher-ref (o1:1)
000878           add +1 to o1
000879        end-if
000880     end-perform
000881
000882     if (wsw-check-no = spaces)
000883        and (wsw-check-dt = spaces)
000884        and (wsw-check-amt = spaces)
000885        display ' empty record ' cps-written-in-rec
000886        go to 2050-read
000887     end-if
000888
000889     string wsw-check-dt (1:4)
000890            wsw-check-dt (6:2)
000891            wsw-check-dt (9:2)
000892        delimited by size into dc-greg-date-cymd-r
000893     end-string
000894     move 'L'                    to dc-option-code
000895     perform 9700-date-convert   thru 9700-exit
000896     if no-conversion-error
000897        move dc-bin-date-1       to ws-bin-check-dt
000898     else
000899        display ' error cvtdte chek dt ' wsw-check-dt ' '
000900           dc-error-code
000901     end-if
000902
000903     perform varying s1 from +1 by +1 until
000904        (s1 > +28)
000905        or (wsw-voucher-ref (s1:6) = 'REF DI' or 'REFUND' or
000906          'CANCEL')
000907     end-perform
000908     if s1 < +29
000909        move 'Bypass- Manual Entry'    to ws-d1-message
000910        move ' '                 to ws-table-sw
000911        go to 2050-continue
000912     end-if
000913
000914*    if wsw-user-defined (1:3) not numeric
000915*       move 'Bypass- Manual Entry'
000916*                                to ws-d1-message
000917*       move ' '                 to ws-table-sw
000918*       go to 2050-continue
000919*    end-if
000920
000921     perform varying s1 from +1 by +1 until
000922        (s1 > +30)
000923        or (wsw-user-defined (s1:1) = ' ')
000924     end-perform
000925     if (s1 < +12)
000926        and (s1 > +8)
000927        continue
000928     else
000929        move 'Bypass- Manual Entry'
000930                                 to ws-d1-message
000931        move ' '                 to ws-table-sw
000932        go to 2050-continue
000933     end-if
000934
000935     move spaces                 to wsw-check-key
000936     perform varying s1 from +30 by -1 until
000937        (s1 < +1)
000938        or (wsw-user-defined (s1:1) numeric)
000939     end-perform
000940     if s1 > +7
000941        move wsw-user-defined (s1 - 6:7)
000942                                 to wsw-check-key
000943     else
000944        move 'Invalid Input CK-KEY'    to ws-d1-message
000945        go to 2050-continue
000946     end-if
000947
000948*    go to 2050-read
000949
000950     move ' '                    to ws-erchek-sw
000951                                    ws-table-sw
000952
000953     perform 2200-get-tbl-row    thru 2200-exit
000954     if sqlcode = 0
000955        set table-found          to true
000956        perform 1020-read-erchek thru 1020-exit
000957        if resp-normal
000958           set erchek-found to true
000959           perform 2310-upd-erchek
000960                                 thru 2310-exit
000961           perform 2320-upd-table
000962                                 thru 2320-exit
000963        else
000964           display ' erchek not fnd ' ch-carrier ' ' ch-state ' '
000965              ch-account ' ' db-effdate (1:10) ' ' db-certificate
000966              ' ' ws-response
000967           move ' chk rec not found ' to ws-d1-message
000968        end-if
000969     else
000970        move ' tbl row not found ' to ws-d1-message
000971     end-if
000972
000973     .
000974 2050-continue.
000975
000976     perform 2400-build-print-line thru 2400-exit
000977     .
000978 2050-read.
000979     perform 2040-read-input     thru 2040-exit
000980
000981     .
000982 2050-exit.
000983     exit.
000984
000985 2200-get-tbl-row.
000986
000987***-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_***
000988***                                                            ***
000989***  I'm only expecting one row so no cursor is declared       ***
000990***                                                            ***
000991***_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-***
000992
000993     move ws-comp-id             to ws-compid
000994     move wsw-check-key-num      to ws-check-key
000995     move 1                      to ws-type
000996
000998     exec sql
              SELECT
000999           CheckKey,
...
001019           :db-account,
001020           :db-effdate,
001021           :db-certificate,
001022           :db-cert-sfx,
001023           :db-seq-no,
001024           :db-type,
001025           :db-amount,
001026           :db-preparer,
001027           :db-check-sub-type
001028        FROM
001029           ChkApp_Check
001030        WHERE
001031           (CheckKey    = :ws-check-key)
001032           and (Company = :ws-compid)
001033     end-exec
001034
001035     if sqlcode not = 0
001036        move sqlcode to ws-sql-code
001037        move ws-sql-code to ws-dis-sql-code
001038        display ' dis sql code ' ws-dis-sql-code
001039        display "Error: cannot read row "
001040        display ' sql return code ' sqlcode
001041        display ' sql err mess    ' sqlerrmc
001042     end-if
001043
001044     .
001045 2200-exit.
001046     exit.
001047
001048 2310-upd-erchek.
001049
001050     if (ch-check-written-dt <> low-values and spaces)
001051        and (ch-check-no <> low-values and spaces)
001052        
      * exec cics unlock
001053*          dataset  ('ERCHEK')
001054*       end-exec
           MOVE 'ERCHEK' TO DFHEIV1
      *    MOVE '&*                    #   #00003067' TO DFHEIV0
           MOVE X'262A20202020202020202020' &
                X'202020202020202020202320' &
                X'2020233030303033303637' TO DFHEIV0
           CALL 'kxdfhei1' USING DFHEIV0, 
                 DFHEIV1, 
                 DFHEIV99
           GO TO 9999-DFHEXIT DEPENDING ON DFHEIGDK
001055        move 'Bypass, Possible Dup'
001056                                 to ws-d1-message
001057        set bypass-rec to true
001058        go to 2310-exit
001059     end-if
001060
001061     move ws-bin-check-dt        to ch-check-written-dt
001062     if wsw-check-no (1:1) = '"'
001063        move wsw-check-no (5:7)  to ch-check-no
001064     else
001065        move wsw-check-no (4:7)  to ch-check-no
001066     end-if
001067
001068*    move zeros                  to ws-response
001069     
      * exec cics rewrite
001070*       dataset     ('ERCHEK')
001071*       from        (check-records)
001072*       resp        (ws-response)
001073*    end-exec
           MOVE LENGTH OF
            check-records
             TO DFHEIV11
           MOVE 'ERCHEK' TO DFHEIV1
      *    MOVE '&& L                  %  N#00003084' TO DFHEIV0
           ...
           GO TO 9999-DFHEXIT DEPENDING ON DFHEIGDK
001074
001075     if resp-normal
001076        add 1 to ws-writ-cnt
001077        compute ws-tot-writ-amt =
001078           ws-tot-writ-amt + ch-amount-paid
001079        move 'Successful Post '  to ws-d1-message
001080     else
001081        move '*** ERROR - NOT POSTED ***' TO ws-d1-message
001082     end-if
001083
001084     .
001085 2310-exit.
001086     exit.
001087
001088 2320-upd-table.
001089
001090     string wsw-check-dt (6:2) '/'
001091            wsw-check-dt (9:2) '/'
001092            wsw-check-dt (1:4)
001093        delimited by size into db-checkdate
001094
001095     move ch-check-no            to db-checkno
001096
001097     if bypass-rec
001098        go to 2320-exit
001099     end-if
001100
001101*    move zeros to sqlcode
001103     EXEC SQL
              UPDATE
001104           ChkApp_Check
001105        SET
001106           CheckNumber = :db-checkno,
001107           CheckDate = :db-checkdate
001108        WHERE
001109           CheckKey = :db-checkkey
001110     END-EXEC
001111
001112     if sqlcode not = 0
001113        move 'Table not updated ' to ws-d1-message
001114        display "Error: cannot update table   "
001115        display ' sql retrun code ' sqlcode
001116        display ' sql err mess    ' sqlerrmc
001117     end-if
001118
001119     .
001120 2320-exit.
001121     exit.
001122
001123 2400-build-print-line.
001124
001125     if table-found
001126        move db-carrier          to ws-d1-carr
001127        move db-grouping         to ws-d1-grp
001128        move db-state            to ws-d1-state
001129        move db-account          to ws-d1-account
001130        string
001131           db-effdate (6:2)   '/'
001132           db-effdate (9:2)   '/'
001133           db-effdate (1:4)
001134           delimited by size into ws-d1-eff-dt
001135        end-string
001136
001137        move db-certificate      to ws-d1-cert-no
001138        move db-cert-sfx         to ws-d1-cert-no (11:1)
001139        if db-check-sub-type = '2'
001140           move 'COR'            to ws-d1-chk-type
001141        else
001142           move 'REF'            to ws-d1-chk-type
001143        end-if
001144*       move +10                 to s2
001145*       move zeros               to ws-work-amt-alpha
001146*       perform varying s1 from +10 by -1 until s1 < +1
001147*          if db-amount (s1:1) numeric
001148*             move db-amount (s1:1)
001149*                                to ws-work-amt-alpha (s2:1)
001150*             subtract +1 from s2
001151*          end-if
001152*       end-perform
001153*       move ws-work-amt-num     to ws-d1-chk-amt
001154        move db-amount           to ws-d1-chk-amt
001155        move db-preparer         to ws-d1-preparer
001156        move db-checkno          to ws-d1-chk-no
001157        move db-checkdate        to ws-d1-writ-cash-dt
001158     else
001159        move wsw-check-no        to ws-d1-chk-no
001160     end-if
001161
001162     perform 4000-write-report   thru 4000-exit
001163     move spaces                 to ws-detail1
001164
001165     .
001166 2400-exit.
001167     exit.
001168
001169 2500-close-files.
001170
001171     close cps-written-in cps-written-rpt
001172
001173     .
001174 2500-exit.
001175     exit.
001176
001177 4000-write-report.
001178
001179     if ws-line-cntr > ws-max-lines
001180        move zeros               to ws-line-cntr
001181        perform 4010-write-headings thru 4010-exit
001182     end-if
001183
001184     move ws-detail1             to cps-written-rpt-rec
001185
001186     perform 4020-write-a-line   thru 4020-exit
001187
001188     .
001189 4000-exit.
001190     exit.
001191 4010-write-headings.
001192
001193     add 1 to ws-page-cntr
001194     move ws-page-cntr           to ws-h3-page
001195
001196     move ws-heading1            to cps-written-rpt-rec
001197     perform 4020-write-a-line   thru 4020-exit
001198
001199     move ws-heading2            to cps-written-rpt-rec
001200     perform 4020-write-a-line   thru 4020-exit
001201
001202     move ws-heading3            to cps-written-rpt-rec
001203     perform 4020-write-a-line   thru 4020-exit
001204
001205     move spaces                 to cps-written-rpt-rec
001206     perform 4020-write-a-line   thru 4020-exit
001207
001208     move spaces                 to cps-written-rpt-rec
001209     perform 4020-write-a-line   thru 4020-exit
001210
001211     move ws-heading4            to cps-written-rpt-rec
001212     perform 4020-write-a-line   thru 4020-exit
001213
001214     move spaces                 to cps-written-rpt-rec
...
001219     exit.
001220
001221 4020-write-a-line.
001222
001223     write cps-written-rpt-rec
001224
001225     add 1 to ws-line-cntr
001226
001227     .
001228 4020-exit.
001229     exit.
001230
001231 5000-submit-job.
001232
001233     
      * EXEC CICS WRITEQ TD
001234*       QUEUE ('BTCH')
001235*       FROM (TRAN-DATA-LINE1)
001236*       LENGTH (80)
001237*    END-EXEC
           MOVE 80
             TO DFHEIV11
           MOVE 'BTCH' TO DFHEIV5
      *    MOVE '(" L   L              &   #00003248' TO DFHEIV0
           MOVE X'2822204C2020204C20202020' &
                X'202020202020202020202620' &
                X'2020233030303033323438' TO DFHEIV0
           CALL 'kxdfhei1' USING DFHEIV0, 
                 DFHEIV5, 
                 TRAN-DATA-LINE1, 
                 DFHEIV11, 
...
001239     
      * EXEC CICS WRITEQ TD
001240*       QUEUE ('BTCH')
001241*       FROM (TRAN-DATA-LINE2)
001242*       LENGTH (80)
001243*    END-EXEC
           MOVE 80
             TO DFHEIV11
           MOVE 'BTCH' TO DFHEIV5
      *    MOVE '(" L   L              &   #00003254' TO DFHEIV0
           MOVE X'2822204C2020204C20202020' &
                X'202020202020202020202620' &
...
001247     exit.
001248
001249 9700-DATE-CONVERT.
001250
001251     
      * EXEC CICS LINK
001252*         PROGRAM  ('ELDATCV')
001253*         COMMAREA (DATE-CONVERSION-DATA)
001254*         LENGTH   (DC-COMM-LENGTH)
001255*    END-EXEC.
           MOVE 'ELDATCV' TO DFHEIV1
      *    MOVE '."C                   (   #00003266' TO DFHEIV0
           MOVE X'2E2243202020202020202020' &
                X'202020202020202020202820' &
                X'2020233030303033323636' TO DFHEIV0
           CALL 'kxdfhei1' USING DFHEIV0, 
                 DFHEIV1, 

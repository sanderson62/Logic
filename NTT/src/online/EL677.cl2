...
NTTChg         16  FILLER                      PIC X(299). *> wass 304
...
030414                                    pi-check-cashed
      ...
      ****  converted to sql server 2016
           ...
           move 'PaidBankInfo'         to p-sql-database
...
PEMMOD           @checkcasheddate = :pb-paid-date :nu-app-date
NTTIns         )
021714     END-EXEC
      *    display 'sqlcode ' sqlcode
      *    display ' date   ' pb-paid-date
      *    display ' nu fld ' nu-app-date
